...
class Realm {
    ...
    static Create(container, promiseJobs) {
        const logger = container.get(kernel_1.ILogger).root.scopeTo('Realm');
        ...
        function def(propertyName, intrinsicName) {
            ...
            (0, operations_js_1.$DefinePropertyOrThrow)(newContext, global, name, desc);
        }
...
exports.ExecutionContextStack = ExecutionContextStack;
