...
class $GeneratorFunctionConstructor extends function_js_1.$BuiltinFunction {
    ...
    performSteps(ctx, thisArgument, argumentsList, NewTarget) {
        ...
        return (0, function_js_2.$CreateDynamicFunction)(ctx, this, NewTarget, 4 /* generator */, argumentsList);
    }
}
...
exports.$GeneratorPrototype_throw = $GeneratorPrototype_throw;
// #endregion
...
exports.$GeneratorInstance = $GeneratorInstance;
...
function $GeneratorStart(ctx, generator, generatorBody) {
    const realm = ctx.Realm;
    const intrinsics = realm['[[Intrinsics]]'];
    ...
    genContext.onResume = function (resumptionValue) {
        ...
        return (0, iteration_js_1.$CreateIterResultObject)(stack.top, resultValue, intrinsics.true);
    };
...
function $GeneratorResume(ctx, _generator, value) {
    ...
    if (state === 4 /* completed */) {
        return (0, iteration_js_1.$CreateIterResultObject)(ctx, intrinsics.undefined, intrinsics.true);
    }
...
function $GeneratorResumeAbrupt(ctx, _generator, abruptCompletion) {
    ...
    if (state === 4 /* completed */) {
        ...
        if (abruptCompletion['[[Type]]'] === 4 /* return */) {
            ...
            return (0, iteration_js_1.$CreateIterResultObject)(ctx, abruptCompletion, intrinsics.true);
        }
...
})(GeneratorKind = exports.GeneratorKind || (exports.GeneratorKind = {}));
// http://www.ecma-international.org/ecma-262/#sec-getgeneratorkind
// 25.4.3.5 GetGeneratorKind ( )
function $GetGeneratorKind(ctx) {
...
function $GeneratorYield(ctx, iterNextObj) {
    const realm = ctx.Realm;
    const intrinsics = realm['[[Intrinsics]]'];
    const stack = realm.stack;
