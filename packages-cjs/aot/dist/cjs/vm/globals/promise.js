...
function $IfAbruptRejectPromise(ctx, value, capability) {
    ...
    if (value.isAbrupt) {
        ...
        const $CallResult = (0, operations_js_1.$Call)(ctx, capability['[[Reject]]'], intrinsics.undefined, new list_js_1.$List(value));
...
function $NewPromiseCapability(ctx, C) {
    ...
    const promise = (0, operations_js_1.$Construct)(ctx, C, new list_js_1.$List(executor), intrinsics.undefined);
...
class PromiseReactionJob extends job_js_1.Job {
    ...
    Run(ctx) {
        ...
        // 6. Else, let handlerResult be Call(handler, undefined, « argument »).
            ...
            handlerResult = (0, operations_js_1.$Call)(ctx, handler, intrinsics.undefined, new list_js_1.$List(argument));
        }
        ...
        if (handlerResult.isAbrupt) {
            ...
            status = (0, operations_js_1.$Call)(ctx, promiseCapability['[[Reject]]'], intrinsics.undefined, new list_js_1.$List(handlerResult));
        }
        // 9. Else,
        else {
            // 9. a. Let status be Call(promiseCapability.[[Resolve]], undefined, « handlerResult.[[Value]] »).
            status = (0, operations_js_1.$Call)(ctx, promiseCapability['[[Resolve]]'], intrinsics.undefined, new list_js_1.$List(handlerResult));
        }
...
class PromiseResolveThenableJob extends job_js_1.Job {
    ...
    Run(ctx) {
        ...
        const thenCallResult = (0, operations_js_1.$Call)(ctx, then, thenable, new list_js_1.$List(resolvingFunctions['[[Resolve]]'], resolvingFunctions['[[Reject]]']));
        ...
        if (thenCallResult.isAbrupt) {
            ...
            const status = (0, operations_js_1.$Call)(ctx, resolvingFunctions['[[Reject]]'], intrinsics.undefined, new list_js_1.$List(thenCallResult));
...
class $PromiseConstructor extends function_js_1.$BuiltinFunction {
    ...
    performSteps(ctx, thisArgument, [executor], NewTarget) {
        ...
        const completion = (0, operations_js_1.$Call)(ctx, executor, intrinsics.undefined, new list_js_1.$List(resolvingFunctions['[[Resolve]]'], resolvingFunctions['[[Reject]]']));
        // 10. If completion is an abrupt completion, then
        if (completion.isAbrupt) {
            // 10. a. Perform ? Call(resolvingFunctions.[[Reject]], undefined, « completion.[[Value]] »).
            const $CallResult = (0, operations_js_1.$Call)(ctx, resolvingFunctions['[[Reject]]'], intrinsics.undefined, new list_js_1.$List(completion));
            if ($CallResult.isAbrupt) {
                return $CallResult;
            }
        }
...
class $Promise_all extends function_js_1.$BuiltinFunction {
    ...
    performSteps(ctx, thisArgument, [iterable], NewTarget) {
        ...
        const iteratorRecord = (0, iteration_js_1.$GetIterator)(ctx, iterable);
        ...
        if (result.isAbrupt) {
            ...
            if (iteratorRecord['[[Done]]'].isFalsey) {
                result = (0, iteration_js_1.$IteratorClose)(ctx, iteratorRecord, result);
            }
    ...
    while (true) {
        ...
        if (next.isFalsey) {
            ...
            if (--remainingElementsCount['[[Value]]'] === 0) {
                ...
                const valuesArray = (0, array_js_1.$CreateArrayFromList)(ctx, values);
                // 6. d. iii. 2. Perform ? Call(resultCapability.[[Resolve]], undefined, « valuesArray »).
                const $CallResult = (0, operations_js_1.$Call)(ctx, resultCapability['[[Resolve]]'], intrinsics.undefined, new list_js_1.$List(valuesArray));
                if ($CallResult.isAbrupt) {
                    return $CallResult;
                }
            }
        ...
        const nextValue = (0, iteration_js_1.$IteratorValue)(ctx, next);
        ...
        const nextPromise = (0, operations_js_1.$Invoke)(ctx, constructor, intrinsics.resolve, new list_js_1.$List(nextValue)); // TODO: fix $Empty typing shenanigans
        ...
        const $InvokeResult = (0, operations_js_1.$Invoke)(ctx, nextPromise, intrinsics.then, new list_js_1.$List(resolveElement, resultCapability['[[Reject]]']));
...
class $Promise_all_ResolveElement extends function_js_1.$BuiltinFunction {
    ...
    performSteps(ctx, thisArgument, [x], NewTarget) {
        ...
        if (--remainingElementsCount['[[Value]]'] === 0) {
            ...
            return (0, operations_js_1.$Call)(ctx, promiseCapability['[[Resolve]]'], intrinsics.undefined, new list_js_1.$List(valuesArray));
        }
        // 12. Return undefined.
        return intrinsics.undefined;
    }
...
function $PerformPromiseRace(ctx, iteratorRecord, constructor, resultCapability) {
    ...
    while (true) {
        ...
        const $InvokeResult = (0, operations_js_1.$Invoke)(ctx, nextPromise, intrinsics.then, new list_js_1.$List(resultCapability['[[Resolve]]'], resultCapability['[[Reject]]']));
        if ($InvokeResult.isAbrupt) {
            return $InvokeResult;
        }
    }
...
class $Promise_reject extends function_js_1.$BuiltinFunction {
    ...
    performSteps(ctx, thisArgument, [r], NewTarget) {
        ...
        const $CallResult = (0, operations_js_1.$Call)(ctx, promiseCapability['[[Resolve]]'], intrinsics.undefined, new list_js_1.$List(r));
        if ($CallResult.isAbrupt) {
            return $CallResult;
        }
...
function $PromiseResolve(ctx, C, x) {
    ...
    const $CallResult = (0, operations_js_1.$Call)(ctx, promiseCapability['[[Resolve]]'], intrinsics.undefined, new list_js_1.$List(x));
    if ($CallResult.isAbrupt) {
        return $CallResult;
    }
    // 5. Return promiseCapability.[[Promise]].
...
class $PromiseProto_catch extends function_js_1.$BuiltinFunction {
    ...
    performSteps(ctx, thisArgument, [onRejected], NewTarget) {
        ...
        return (0, operations_js_1.$Invoke)(ctx, promise, intrinsics.then, new list_js_1.$List(intrinsics.undefined, onRejected)); // TODO: fix $Empty typings
    }
}
...
class $PromiseProto_finally extends function_js_1.$BuiltinFunction {
    ...
    performSteps(ctx, thisArgument, [onFinally], NewTarget) {
        ...
        const C = (0, operations_js_1.$SpeciesConstructor)(ctx, promise, intrinsics['%Promise%']);
        if (C.isAbrupt) {
            return C;
        }
        let thenFinally;
        ...
        return (0, operations_js_1.$Invoke)(ctx, promise, intrinsics.then, new list_js_1.$List(thenFinally, catchFinally)); // TODO: fix typings $Empty shenanigans
    }
}
...
class $ThenFinally extends function_js_1.$BuiltinFunction {
    ...
    performSteps(ctx, thisArgument, [value], NewTarget) {
        ...
        const result = (0, operations_js_1.$Call)(ctx, onFinally, intrinsics.undefined, intrinsics.undefined);
        if (result.isAbrupt) {
            return result;
        }
        ...
        return (0, operations_js_1.$Invoke)(ctx, promise, intrinsics.then, new list_js_1.$List(valueThunk)); // TODO: fix typings $Empty shenanigans
    }
}
...
class $CatchFinally extends function_js_1.$BuiltinFunction {
    ...
    performSteps(ctx, thisArgument, [value], NewTarget) {
        ...
        return (0, operations_js_1.$Invoke)(ctx, promise, intrinsics.then, new list_js_1.$List(thrower)); // TODO: fix typings $Empty shenanigans
    }
}
...
class $PromiseInstance extends object_js_1.$Object {
    ...
    static Create(ctx, NewTarget) {
        const proto = (0, function_js_1.$GetPrototypeFromConstructor)(ctx, NewTarget, '%PromisePrototype%');
        if (proto.isAbrupt) {
            return proto;
        }
