...
function $GetIterator(ctx, obj, hint, method) {
    ...
    if (method === void 0) {
        ...
        if (hint === 'async') {
            ...
            const $method = (0, operations_js_1.$GetMethod)(ctx, obj, intrinsics['@@asyncIterator']);
            if ($method.isAbrupt) {
                return $method;
            }
            method = $method;
            ...
            if (method.isUndefined) {
                ...
                const syncMethod = (0, operations_js_1.$GetMethod)(ctx, obj, intrinsics['@@iterator']);
            ...
            const $method = (0, operations_js_1.$GetMethod)(ctx, obj, intrinsics['@@iterator']);
            if ($method.isAbrupt) {
                return $method;
            }
            method = $method;
    ...
    const iterator = (0, operations_js_1.$Call)(ctx, method, obj, intrinsics.undefined);
...
function $IteratorNext(ctx, iteratorRecord, value) {
    ...
    if (value === void 0) {
        ...
        const $result = (0, operations_js_1.$Call)(ctx, iteratorRecord['[[NextMethod]]'], iteratorRecord['[[Iterator]]'], intrinsics.undefined);
        if ($result.isAbrupt) {
            return $result;
        }
        result = $result;
    ...
    // 2. Else,
        ...
        const $result = (0, operations_js_1.$Call)(ctx, iteratorRecord['[[NextMethod]]'], iteratorRecord['[[Iterator]]'], new list_js_1.$List(value));
        if ($result.isAbrupt) {
            return $result;
        }
        result = $result;
...
function $IteratorClose(ctx, iteratorRecord, completion) {
    ...
    const innerResult = (0, operations_js_1.$Call)(ctx, $return, iterator, intrinsics.undefined);
...
function $CreateIterResultObject(ctx, value, done) {
    ...
    (0, operations_js_1.$CreateDataProperty)(ctx, obj, intrinsics.$value, value);
    // 4. Perform CreateDataProperty(obj, "done", done).
    (0, operations_js_1.$CreateDataProperty)(ctx, obj, intrinsics.$done, done);
    // 5. Return obj.
    return obj;
}
...
class $IteratorPrototype extends object_js_1.$Object {
    constructor(realm, proto) {
        ...
        (0, operations_js_1.$DefinePropertyOrThrow)(realm.stack.top, this, intrinsics['@@iterator'], new property_descriptor_js_1.$PropertyDescriptor(realm, intrinsics['@@iterator'], {
...
class $AsyncIteratorPrototype extends object_js_1.$Object {
    constructor(realm, proto) {
        ...
        (0, operations_js_1.$DefinePropertyOrThrow)(realm.stack.top, this, intrinsics['@@asyncIterator'], new property_descriptor_js_1.$PropertyDescriptor(realm, intrinsics['@@asyncIterator'], {
...
class $AsyncFromSyncIteratorPrototype_next extends function_js_1.$BuiltinFunction {
    ...
    performSteps(ctx, thisArgument, [value], NewTarget) {
        ...
        const promiseCapability = (0, promise_js_1.$NewPromiseCapability)(ctx, intrinsics['%Promise%']);
        ...
        if (!(O instanceof $AsyncFromSyncIterator)) {
            ...
            (0, operations_js_1.$Call)(ctx, promiseCapability['[[Reject]]'], intrinsics.undefined, new list_js_1.$List(invalidIteratorError));
        ...
        const $IfAbruptRejectPromiseResult = (0, promise_js_1.$IfAbruptRejectPromise)(ctx, result, promiseCapability);
...
class $AsyncFromSyncIteratorPrototype_return extends function_js_1.$BuiltinFunction {
    ...
    performSteps(ctx, thisArgument, [value], NewTarget) {
        ...
        const $return = (0, operations_js_1.$GetMethod)(ctx, syncIterator, intrinsics.return);
        // 6. IfAbruptRejectPromise(return, promiseCapability).
        let $IfAbruptRejectPromiseResult = (0, promise_js_1.$IfAbruptRejectPromise)(ctx, $return, promiseCapability);
        if ($IfAbruptRejectPromiseResult.isAbrupt) {
            return $IfAbruptRejectPromiseResult;
        }
        ...
        if ($return.isUndefined) {
            ...
            (0, operations_js_1.$Call)(ctx, promiseCapability['[[Resolve]]'], intrinsics.undefined, new list_js_1.$List(iterResult));
            // 7. c. Return promiseCapability.[[Promise]].
            return promiseCapability['[[Promise]]'];
        }
        // 8. Let result be Call(return, syncIterator, « value »).
        const result = (0, operations_js_1.$Call)(ctx, $return, syncIterator, new list_js_1.$List(value));
        // 9. IfAbruptRejectPromise(result, promiseCapability).
        $IfAbruptRejectPromiseResult = (0, promise_js_1.$IfAbruptRejectPromise)(ctx, result, promiseCapability);
        if ($IfAbruptRejectPromiseResult.isAbrupt) {
            return $IfAbruptRejectPromiseResult;
        }
        ...
        if (!result.isObject) {
            ...
            (0, operations_js_1.$Call)(ctx, promiseCapability['[[Reject]]'], intrinsics.undefined, new list_js_1.$List(err));
...
class $AsyncFromSyncIteratorPrototype_throw extends function_js_1.$BuiltinFunction {
    ...
    performSteps(ctx, thisArgument, [value], NewTarget) {
        ...
        const $throw = (0, operations_js_1.$GetMethod)(ctx, syncIterator, intrinsics.throw);
        // 6. IfAbruptRejectPromise(throw, promiseCapability).
        let $IfAbruptRejectPromiseResult = (0, promise_js_1.$IfAbruptRejectPromise)(ctx, $throw, promiseCapability);
        if ($IfAbruptRejectPromiseResult.isAbrupt) {
            return $IfAbruptRejectPromiseResult;
        }
        ...
        if ($throw.isUndefined) {
            ...
            (0, operations_js_1.$Call)(ctx, promiseCapability['[[Resolve]]'], intrinsics.undefined, new list_js_1.$List(value));
            // 7. b. Return promiseCapability.[[Promise]].
            return promiseCapability['[[Promise]]'];
        }
        // 8. Let result be Call(throw, syncIterator, « value »).
        const result = (0, operations_js_1.$Call)(ctx, $throw, syncIterator, new list_js_1.$List(value));
        // 9. IfAbruptRejectPromise(result, promiseCapability).
        $IfAbruptRejectPromiseResult = (0, promise_js_1.$IfAbruptRejectPromise)(ctx, result, promiseCapability);
        if ($IfAbruptRejectPromiseResult.isAbrupt) {
            return $IfAbruptRejectPromiseResult;
...
function $AsyncFromSyncIteratorContinuation(ctx, result, promiseCapability) {
    ...
    let $IfAbruptRejectPromiseResult = (0, promise_js_1.$IfAbruptRejectPromise)(ctx, done, promiseCapability);
    if ($IfAbruptRejectPromiseResult.isAbrupt) {
        return $IfAbruptRejectPromiseResult;
    }
    ...
    $IfAbruptRejectPromiseResult = (0, promise_js_1.$IfAbruptRejectPromise)(ctx, value, promiseCapability);
    if ($IfAbruptRejectPromiseResult.isAbrupt) {
        return $IfAbruptRejectPromiseResult;
    }
    // 5. Let valueWrapper be ? PromiseResolve(%Promise%, « value »).
    const valueWrapper = (0, promise_js_1.$PromiseResolve)(ctx, intrinsics['%Promise%'], new list_js_1.$List(value)); // TODO: fix types
    ...
    (0, promise_js_1.$PerformPromiseThen)(ctx, valueWrapper, onFulfilled, intrinsics.undefined, promiseCapability);
