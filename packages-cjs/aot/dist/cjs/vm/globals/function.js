...
class $FunctionPrototype_call extends function_js_1.$BuiltinFunction {
    ...
    performSteps(ctx, thisArgument, [thisArg, ...args], NewTarget) {
        ...
        realm.stack.pop();
        // 6. Return ? Call(func, thisArg, argList).
        return (0, operations_js_1.$Call)(realm.stack.top, func, thisArg, argList);
    }
}
...
function $CreateDynamicFunction(ctx, constructor, newTarget, kind, args) {
    ...
    const $HostEnsureCanCompileStringsResult = (0, operations_js_1.$HostEnsureCanCompileStrings)(ctx, callerRealm, calleeRealm);
    ...
    const node = (0, typescript_1.createSourceFile)('', sourceText, typescript_1.ScriptTarget.Latest).statements[0];
    ...
    const proto = (0, function_js_1.$GetPrototypeFromConstructor)(ctx, newTarget, fallbackProto);
    if (proto.isAbrupt) {
        return proto;
    }
    ...
    if (kind === 4 /* generator */) {
        ...
        (0, operations_js_1.$DefinePropertyOrThrow)(ctx, F, intrinsics.$prototype, new property_descriptor_js_1.$PropertyDescriptor(realm, intrinsics.$prototype, {
            '[[Value]]': prototype,
