...
class $AsyncGeneratorFunctionConstructor extends function_js_1.$BuiltinFunction {
    ...
    performSteps(ctx, thisArgument, argumentsList, NewTarget) {
        ...
        return (0, function_js_2.$CreateDynamicFunction)(ctx, this, NewTarget, 12 /* asyncGenerator */, argumentsList);
    }
}
...
exports.$AsyncGeneratorPrototype_throw = $AsyncGeneratorPrototype_throw;
// #endregion
...
exports.$AsyncGeneratorInstance = $AsyncGeneratorInstance;
    ...
    genContext.onResume = function (resumptionValue) {
        ...
        // 5. f. Else,
            ...
            if (result['[[Type]]'] !== 4 /* return */) {
                ...
                return $AsyncGeneratorReject(ctx, generator, resultValue);
            }
        }
...
function $AsyncGeneratorResolve(ctx, generator, value, done) {
    ...
    const iteratorResult = (0, iteration_js_1.$CreateIterResultObject)(ctx, value, done);
    // 7. Perform ! Call(promiseCapability.[[Resolve]], undefined, « iteratorResult »).
    (0, operations_js_1.$Call)(ctx, promiseCapability['[[Resolve]]'], intrinsics.undefined, new list_js_1.$List(iteratorResult));
...
function $AsyncGeneratorReject(ctx, generator, exception) {
    ...
    (0, operations_js_1.$Call)(ctx, promiseCapability['[[Reject]]'], intrinsics.undefined, new list_js_1.$List(exception));
    ...
    if (completion.isAbrupt) {
        ...
        if (state === 5 /* completed */) {
            ...
            completion['[[Type]]'] === 4 /* return */) {
                ...
                const promise = (0, promise_js_1.$PromiseResolve)(ctx, intrinsics['%Promise%'], new list_js_1.$List(completion)); // TODO: this cast urgently needs to be addressed with corrected typings
                if (promise.isAbrupt) {
                    return promise;
                }
...
exports.$AsyncGeneratorResumeNext_Return_Processor_Rejected = $AsyncGeneratorResumeNext_Return_Processor_Rejected;
...
function $AsyncGeneratorEnqueue(ctx, generator, completion) {
    ...
    if (!(generator instanceof $AsyncGeneratorInstance)) {
        ...
        (0, operations_js_1.$Call)(ctx, promiseCapability['[[Reject]]'], intrinsics.undefined, new list_js_1.$List(badGeneratorError));
...
function $AsyncGeneratorYield(ctx, value) {
    const realm = ctx.Realm;
    const intrinsics = realm['[[Intrinsics]]'];
    const stack = realm.stack;
    ...
    value = (0, await_js_1.$Await)(ctx, value); // TODO: something is not quite right here w.r.t. value propagation. Need to revisit
    ...
    genContext.onResume = function (resumptionValue) {
        ...
        if (resumptionValue['[[Type]]'] !== 4 /* return */) {
            return resumptionValue;
        }
        // 8. b. Let awaited be Await(resumptionValue.[[Value]]).
        const awaited = (0, await_js_1.$Await)(ctx, resumptionValue);
        ...
        return awaited.ToCompletion(4 /* return */, intrinsics.empty); // TODO: we never return the resumptionValue from $Await so need to revisit this
