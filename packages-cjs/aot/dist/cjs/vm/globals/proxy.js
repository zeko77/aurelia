...
class $Proxy_revocable extends function_js_1.$BuiltinFunction {
    ...
    performSteps(ctx, thisArgument, [target, handler], NewTarget) {
        ...
        (0, operations_js_1.$CreateDataProperty)(ctx, result, new string_js_1.$String(realm, 'proxy'), p);
        // 7. Perform CreateDataProperty(result, "revoke", revoker).
        (0, operations_js_1.$CreateDataProperty)(ctx, result, new string_js_1.$String(realm, 'revoke'), revoker);
        // 8. Return result.
        return result;
    }
}
