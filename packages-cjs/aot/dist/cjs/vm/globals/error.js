...
class $ErrorConstructor extends function_js_1.$BuiltinFunction {
    ...
    performSteps(ctx, thisArgument, [message], NewTarget) {
        ...
        const O = (0, function_js_1.$OrdinaryCreateFromConstructor)(ctx, newTarget, '%ErrorPrototype%', { '[[ErrorData]]': void 0 });
        if (O.isAbrupt) {
            return O;
        }
        ...
        if (message !== void 0) {
            ...
            (0, operations_js_1.$DefinePropertyOrThrow)(ctx, O, intrinsics.message, msgDesc);
        }
        // 4. Return O.
        return O;
    }
...
class $EvalErrorConstructor extends function_js_1.$BuiltinFunction {
    ...
    performSteps(ctx, thisArgument, [message], NewTarget) {
        ...
        const O = (0, function_js_1.$OrdinaryCreateFromConstructor)(ctx, newTarget, '%EvalErrorPrototype%', { '[[ErrorData]]': void 0 });
        if (O.isAbrupt) {
            return O;
        }
        // 3. If message is not undefined, then
...
class $RangeErrorConstructor extends function_js_1.$BuiltinFunction {
    ...
    performSteps(ctx, thisArgument, [message], NewTarget) {
        ...
        const O = (0, function_js_1.$OrdinaryCreateFromConstructor)(ctx, newTarget, '%RangeErrorPrototype%', { '[[ErrorData]]': void 0 });
        if (O.isAbrupt) {
            return O;
        }
        // 3. If message is not undefined, then
...
class $ReferenceErrorConstructor extends function_js_1.$BuiltinFunction {
    ...
    performSteps(ctx, thisArgument, [message], NewTarget) {
        ...
        const O = (0, function_js_1.$OrdinaryCreateFromConstructor)(ctx, newTarget, '%ReferenceErrorPrototype%', { '[[ErrorData]]': void 0 });
        if (O.isAbrupt) {
            return O;
        }
        // 3. If message is not undefined, then
...
class $SyntaxErrorConstructor extends function_js_1.$BuiltinFunction {
    ...
    performSteps(ctx, thisArgument, [message], NewTarget) {
        ...
        const O = (0, function_js_1.$OrdinaryCreateFromConstructor)(ctx, newTarget, '%SyntaxErrorPrototype%', { '[[ErrorData]]': void 0 });
        if (O.isAbrupt) {
            return O;
        }
        // 3. If message is not undefined, then
...
class $TypeErrorConstructor extends function_js_1.$BuiltinFunction {
    ...
    performSteps(ctx, thisArgument, [message], NewTarget) {
        ...
        const O = (0, function_js_1.$OrdinaryCreateFromConstructor)(ctx, newTarget, '%TypeErrorPrototype%', { '[[ErrorData]]': void 0 });
        if (O.isAbrupt) {
            return O;
        }
        // 3. If message is not undefined, then
...
class $URIErrorConstructor extends function_js_1.$BuiltinFunction {
    ...
    performSteps(ctx, thisArgument, [message], NewTarget) {
        ...
        const O = (0, function_js_1.$OrdinaryCreateFromConstructor)(ctx, newTarget, '%URIErrorPrototype%', { '[[ErrorData]]': void 0 });
        if (O.isAbrupt) {
            return O;
        }
        // 3. If message is not undefined, then
