...
class $ObjectEnvRec {
    ...
    CreateMutableBinding(ctx, N, D) {
        ...
        Desc['[[Configurable]]'] = D;
        return (0, operations_js_1.$DefinePropertyOrThrow)(ctx, bindings, N, Desc);
    }
    ...
    SetMutableBinding(ctx, N, V, S) {
        ...
        return (0, operations_js_1.$Set)(ctx, bindings, N, V, S);
    }
...
class $GlobalEnvRec {
    ...
    DeleteBinding(ctx, N) {
        ...
        const existingProp = (0, operations_js_1.$HasOwnProperty)(ctx, globalObject, N);
    ...
    CanDeclareGlobalVar(ctx, N) {
        ...
        const hasProperty = (0, operations_js_1.$HasOwnProperty)(ctx, globalObject, N);
    ...
    CreateGlobalFunctionBinding(ctx, N, V, D) {
        ...
        const $DefinePropertyOrThrowResult = (0, operations_js_1.$DefinePropertyOrThrow)(ctx, globalObject, N, desc);
        ...
        const $SetResult = (0, operations_js_1.$Set)(ctx, globalObject, N, V, intrinsics.false);
