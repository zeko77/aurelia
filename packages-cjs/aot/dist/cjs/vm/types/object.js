...
class $Object {
    ...
    ToPrimitive(ctx, PreferredType = 'default') {
        ...
        if (!exoticToPrim.isUndefined) {
            ...
            const result = (0, operations_js_1.$Call)(ctx, exoticToPrim, input, new list_js_1.$List(hint));
            if (result.isAbrupt) {
                return result;
            }
    ...
    OrdinaryToPrimitive(ctx, hint) {
        ...
        if (hint === 'string') {
            ...
            if (method.isFunction) {
                ...
                const result = (0, operations_js_1.$Call)(ctx, method, O, intrinsics.undefined);
                if (result.isAbrupt) {
                    return result;
                }
    ...
    '[[DefineOwnProperty]]'(ctx, P, Desc) {
        ...
        return (0, operations_js_1.$ValidateAndApplyPropertyDescriptor)(ctx, O, P, extensible, Desc, current);
    }
    ...
    '[[Get]]'(ctx, P, Receiver) {
        ...
        return (0, operations_js_1.$Call)(ctx, getter, Receiver, intrinsics.undefined);
    }
    ...
    '[[Set]]'(ctx, P, V, Receiver) {
        ...
        return (0, operations_js_1.$OrdinarySetWithOwnDescriptor)(ctx, O, P, V, Receiver, ownDesc);
    }
