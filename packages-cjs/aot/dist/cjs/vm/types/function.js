...
class $Function extends object_js_1.$Object {
    ...
    toString() {
        ...
        let character = -1;
        if (node.pos > -1) {
            ({ line, character } = (0, typescript_1.getLineAndCharacterOfPosition)(sourceFile, node.getStart(sourceFile)));
        }
    ...
    static FunctionInitialize(ctx, F, kind, code, Scope) {
        ...
        (0, operations_js_1.$DefinePropertyOrThrow)(ctx, F, intrinsics.length, Desc);
    ...
    MakeConstructor(ctx, writablePrototype, prototype) {
        ...
        if (prototype === void 0) {
            ...
            Desc['[[Enumerable]]'] = intrinsics.false;
            Desc['[[Configurable]]'] = intrinsics.true;
            (0, operations_js_1.$DefinePropertyOrThrow)(ctx, prototype, intrinsics.$constructor, Desc);
        }
        ...
        (0, operations_js_1.$DefinePropertyOrThrow)(ctx, F, intrinsics.$prototype, Desc);
    ...
    SetFunctionName(ctx, name, prefix) {
        ...
        Desc['[[Enumerable]]'] = intrinsics.false;
        Desc['[[Configurable]]'] = intrinsics.true;
        return (0, operations_js_1.$DefinePropertyOrThrow)(ctx, this, intrinsics.$name, Desc);
    }
}
