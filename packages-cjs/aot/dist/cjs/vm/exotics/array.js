...
function $ArraySpeciesCreate(ctx, originalArray, length) {
    ...
    if (C.isFunction) {
        ...
        const realmC = (0, operations_js_1.$GetFunctionRealm)(ctx, C);
        if (realmC.isAbrupt) {
            return realmC;
        }
    ...
    return (0, operations_js_1.$Construct)(ctx, C, new list_js_1.$List(length), intrinsics.undefined);
}
...
function $CreateArrayFromList(ctx, elements) {
    ...
    for (const e of elements) {
        ...
        const status = (0, operations_js_1.$CreateDataProperty)(ctx, array, new string_js_1.$String(realm, n.toString()), e);
