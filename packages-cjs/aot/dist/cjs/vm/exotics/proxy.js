...
class $ProxyExoticObject extends object_js_1.$Object {
    ...
    '[[GetPrototypeOf]]'(ctx) {
        ...
        const handlerProto = (0, operations_js_1.$Call)(ctx, trap, handler, new list_js_1.$List(target));
    ...
    '[[SetPrototypeOf]]'(ctx, V) {
        ...
        const booleanTrapResult = (0, operations_js_1.$Call)(ctx, trap, handler, new list_js_1.$List(target, V)).ToBoolean(ctx);
    ...
    '[[IsExtensible]]'(ctx) {
        ...
        const booleanTrapResult = (0, operations_js_1.$Call)(ctx, trap, handler, new list_js_1.$List(target)).ToBoolean(ctx);
    ...
    '[[GetOwnProperty]]'(ctx, P) {
        ...
        const trapResultObj = (0, operations_js_1.$Call)(ctx, trap, handler, new list_js_1.$List(target, P));
        ...
        const resultDesc = (0, operations_js_1.$ToPropertyDescriptor)(ctx, trapResultObj, P);
        ...
        const valid = (0, operations_js_1.$ValidateAndApplyPropertyDescriptor)(ctx, 
    ...
    '[[DefineOwnProperty]]'(ctx, P, Desc) {
        ...
        const descObj = (0, operations_js_1.$FromPropertyDescriptor)(ctx, Desc);
        if (descObj.isAbrupt) {
            return descObj;
        } // TODO: spec doesn't say this. maybe we need to fix the types somehow?
        // 9. Let booleanTrapResult be ToBoolean(? Call(trap, handler, « target, P, descObj »)).
        const booleanTrapResult = (0, operations_js_1.$Call)(ctx, trap, handler, new list_js_1.$List(target, P, descObj)).ToBoolean(ctx);
        if (booleanTrapResult.isAbrupt) {
            return booleanTrapResult;
        }
        ...
        // 16. Else targetDesc is not undefined,
            ...
            if ((0, operations_js_1.$ValidateAndApplyPropertyDescriptor)(ctx, 
            /* O */ intrinsics.undefined, 
            /* P */ intrinsics.undefined, 
            /* extensible */ extensibleTarget, 
            /* Desc */ Desc, 
    ...
    '[[HasProperty]]'(ctx, P) {
        ...
        const booleanTrapResult = (0, operations_js_1.$Call)(ctx, trap, handler, new list_js_1.$List(target, P)).ToBoolean(ctx);
        if (booleanTrapResult.isAbrupt) {
            return booleanTrapResult;
        }
    ...
    '[[Get]]'(ctx, P, Receiver) {
        ...
        const trapResult = (0, operations_js_1.$Call)(ctx, trap, handler, new list_js_1.$List(target, P, Receiver));
    ...
    '[[Set]]'(ctx, P, V, Receiver) {
        ...
        const booleanTrapResult = (0, operations_js_1.$Call)(ctx, trap, handler, new list_js_1.$List(target, P, V, Receiver)).ToBoolean(ctx);
        if (booleanTrapResult.isAbrupt) {
            return booleanTrapResult;
        }
        // 9. If booleanTrapResult is false, return false.
    ...
    '[[OwnPropertyKeys]]'(ctx) {
        ...
        const trapResultArray = (0, operations_js_1.$Call)(ctx, trap, handler, new list_js_1.$List(target));
        if (trapResultArray.isAbrupt) {
            return trapResultArray;
        }
        // 8. Let trapResult be ? CreateListFromArrayLike(trapResultArray, « String, Symbol »).
        const trapResult = (0, operations_js_1.$CreateListFromArrayLike)(ctx, trapResultArray, ['String', 'Symbol']);
        if (trapResult.isAbrupt) {
            return trapResult;
        }
    ...
    '[[Call]]'(ctx, thisArgument, argumentsList) {
        ...
        if (trap.isUndefined) {
            ...
            return (0, operations_js_1.$Call)(ctx, target, thisArgument, argumentsList);
        }
        // 7. Let argArray be CreateArrayFromList(argumentsList).
        const argArray = (0, array_js_1.$CreateArrayFromList)(ctx, argumentsList);
        // 8. Return ? Call(trap, handler, « target, thisArgument, argArray »).
        return (0, operations_js_1.$Call)(ctx, trap, handler, new list_js_1.$List(target, thisArgument, argArray));
    }
    ...
    '[[Construct]]'(ctx, argumentsList, newTarget) {
        ...
        if (trap.isUndefined) {
            ...
            return (0, operations_js_1.$Construct)(ctx, target, argumentsList, newTarget);
        }
        // 8. Let argArray be CreateArrayFromList(argumentsList).
        const argArray = (0, array_js_1.$CreateArrayFromList)(ctx, argumentsList);
        // 9. Let newObj be ? Call(trap, handler, « target, argArray, newTarget »).
        const newObj = (0, operations_js_1.$Call)(ctx, trap, handler, new list_js_1.$List(target, argArray, newTarget));
        if (newObj.isAbrupt) {
            return newObj;
        }
...
exports.$ProxyExoticObject = $ProxyExoticObject;
