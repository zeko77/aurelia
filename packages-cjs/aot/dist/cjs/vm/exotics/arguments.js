...
class $ArgumentsExoticObject extends object_js_1.$Object {
    ...
    constructor(realm, func, formals, argumentsList, env) {
        ...
        while (index < len) {
            ...
            (0, operations_js_1.$CreateDataProperty)(ctx, this, new string_js_1.$String(realm, index.toString()), val);
        ...
        (0, operations_js_1.$DefinePropertyOrThrow)(ctx, this, iteratorDesc.name, iteratorDesc);
        ...
        (0, operations_js_1.$DefinePropertyOrThrow)(ctx, this, calleeDesc.name, calleeDesc);
        // 24. Return obj.
    }
    ...
    '[[GetOwnProperty]]'(ctx, P) {
        ...
        const isMapped = (0, operations_js_1.$HasOwnProperty)(ctx, map, P).isTruthy;
    ...
    '[[DefineOwnProperty]]'(ctx, P, Desc) {
        ...
        if (isMapped && (0, property_descriptor_js_1.$IsDataDescriptor)(Desc)) {
        ...
        // 8. b. Else,
            ...
            if (Desc['[[Value]]'].hasValue) {
                ...
                const setStatus = (0, operations_js_1.$Set)(ctx, map, P, Desc['[[Value]]'], intrinsics.false);
    ...
    '[[Set]]'(ctx, P, V, Receiver) {
        ...
        if (this.is(Receiver)) {
            ...
            const isMapped = (0, operations_js_1.$HasOwnProperty)(ctx, map, P).isTruthy;
            if (isMapped) {
                const setStatus = (0, operations_js_1.$Set)(ctx, map, P, V, intrinsics.false);
            }
        }
...
function $CreateUnmappedArgumentsObject(ctx, argumentsList) {
    ...
    (0, operations_js_1.$DefinePropertyOrThrow)(ctx, obj, intrinsics.length, new property_descriptor_js_1.$PropertyDescriptor(realm, intrinsics.length, {
    ...
    while (index < len) {
        ...
        (0, operations_js_1.$CreateDataProperty)(ctx, obj, new string_js_1.$String(realm, index.toString()), val);
    ...
    (0, operations_js_1.$DefinePropertyOrThrow)(ctx, obj, intrinsics['@@iterator'], new property_descriptor_js_1.$PropertyDescriptor(realm, intrinsics['@@iterator'], {
        '[[Value]]': intrinsics['%ArrayProto_values%'],
        '[[Writable]]': intrinsics.true,
        '[[Enumerable]]': intrinsics.false,
        '[[Configurable]]': intrinsics.true,
    ...
    (0, operations_js_1.$DefinePropertyOrThrow)(ctx, obj, intrinsics.$callee, new property_descriptor_js_1.$PropertyDescriptor(realm, intrinsics.$callee, {
