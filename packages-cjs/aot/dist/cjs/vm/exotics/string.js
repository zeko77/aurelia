...
class $StringExoticObject extends object_js_1.$Object {
    ...
    constructor(realm, value, proto) {
        ...
        (0, operations_js_1.$DefinePropertyOrThrow)(realm.stack.top, this, realm['[[Intrinsics]]'].length, new property_descriptor_js_1.$PropertyDescriptor(realm, realm['[[Intrinsics]]'].length, {
    ...
    '[[DefineOwnProperty]]'(ctx, P, Desc) {
        ...
        if (!stringDesc.isUndefined) {
            ...
            return (0, operations_js_1.$ValidateAndApplyPropertyDescriptor)(ctx, 
