...
class $ESScript {
    constructor(logger, $file, node, realm) {
        ...
        let ctx = 0 /* None */;
        this.DirectivePrologue = (0, _shared_js_1.GetDirectivePrologue)(node.statements);
        ...
        for (let i = 0, ii = statements.length; i < ii; ++i) {
            ...
            switch (stmt.kind) {
                ...
                case typescript_1.SyntaxKind.VariableStatement:
                    ...
                    if ((0, _shared_js_1.hasBit)($stmt.modifierFlags, typescript_1.ModifierFlags.Export)) {
                        ExportedBindings.push(...$stmt.ExportedBindings);
                        ExportedNames.push(...$stmt.ExportedNames);
                        ExportEntries.push(...$stmt.ExportEntries);
                    }
...
class $ModuleDeclaration {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.ModuleDeclaration`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
...
class $ImportEqualsDeclaration {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.ImportEqualsDeclaration`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
...
class $ImportDeclaration {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.ImportDeclaration`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
...
class $ExportAssignment {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.ExportAssignment`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
...
class $ExportDeclaration {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.ExportDeclaration`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
...
class $NamespaceExportDeclaration {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.NamespaceExportDeclaration`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
