...
class $VariableStatement {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.VariableStatement`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
        ...
        if ((0, _shared_js_1.hasBit)(this.modifierFlags, typescript_1.ModifierFlags.Export)) {
            ctx |= 4096 /* InExport */;
        }
        ...
        if ((0, _shared_js_1.hasBit)(ctx, 4096 /* InExport */)) {
...
class $VariableDeclaration {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.VariableDeclaration`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
        ...
        this.LexicallyDeclaredNames = kernel_1.emptyArray;
        this.LexicallyScopedDeclarations = kernel_1.emptyArray;
        const modifierFlags = this.modifierFlags = (0, _shared_js_1.modifiersToModifierFlags)(node.modifiers);
        if ((0, _shared_js_1.hasBit)(ctx, 4 /* InVariableStatement */)) {
            this.combinedModifierFlags = modifierFlags | parent.combinedModifierFlags;
        }
        else {
            this.combinedModifierFlags = modifierFlags;
        }
        const $name = this.$name = (0, _shared_js_1.$$bindingName)(node.name, this, ctx, -1);
        ...
        ctx = (0, _shared_js_1.clearBit)(ctx, 4 /* InVariableStatement */);
        this.$initializer = (0, _shared_js_1.$assignmentExpression)(node.initializer, this, ctx, -1);
        this.BoundNames = $name.BoundNames;
        if ((0, _shared_js_1.hasBit)(ctx, 32768 /* IsVar */)) { // TODO: what about parameter and for declarations?
            ...
            this.IsConstantDeclaration = (0, _shared_js_1.hasBit)(ctx, 8192 /* IsConst */);
        }
    }
...
class $VariableDeclarationList {
    constructor(node, parent, ctx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}.VariableDeclarationList`) {
        ...
        if ((0, _shared_js_1.hasBit)(node.flags, typescript_1.NodeFlags.Const)) {
            ctx |= 8192 /* IsConst */;
        }
        else if ((0, _shared_js_1.hasBit)(node.flags, typescript_1.NodeFlags.Let)) {
            ctx |= 16384 /* IsLet */;
        }
        else {
            ctx |= 32768 /* IsVar */;
...
// #region Statements
class $Block {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.Block`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
        ...
        this.TypeDeclarations = kernel_1.emptyArray;
        this.IsType = false;
        const $statements = this.$statements = (0, _shared_js_1.$$tsStatementList)(node.statements, this, ctx);
    ...
    Evaluate(ctx) {
        ...
        const $BlockDeclarationInstantiationResult = (0, _shared_js_1.BlockDeclarationInstantiation)(ctx, this.LexicallyScopedDeclarations, blockEnv);
        ...
        const blockValue = (0, _shared_js_1.evaluateStatementList)(ctx, $statements);
...
class $EmptyStatement {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.EmptyStatement`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
...
class $ExpressionStatement {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.ExpressionStatement`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
...
class $IfStatement {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.IfStatement`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
        ...
        this.LexicallyScopedDeclarations = kernel_1.emptyArray;
        this.$expression = (0, _shared_js_1.$assignmentExpression)(node.expression, this, ctx, -1);
        const $thenStatement = this.$thenStatement = (0, _shared_js_1.$$esLabelledItem)(node.thenStatement, this, ctx, -1);
        if (node.elseStatement === void 0) {
            ...
            const $elseStatement = this.$elseStatement = (0, _shared_js_1.$$esLabelledItem)(node.elseStatement, this, ctx, -1);
    ...
    Evaluate(ctx) {
        ...
        if ($elseStatement !== undefined) {
            ...
            if (exprValue.is(intrinsics.true)) {
                ...
                stmtCompletion = (0, _shared_js_1.evaluateStatement)(ctx, $thenStatement);
            }
            else {
                // 4. Else,
                // 4. a. Let stmtCompletion be the result of evaluating the second Statement.
                stmtCompletion = (0, _shared_js_1.evaluateStatement)(ctx, $elseStatement);
            }
...
class $DoStatement {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.DoStatement`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
        ...
        this.LexicallyDeclaredNames = kernel_1.emptyArray;
        this.LexicallyScopedDeclarations = kernel_1.emptyArray;
        const $statement = this.$statement = (0, _shared_js_1.$$esLabelledItem)(node.statement, this, ctx, -1);
        this.$expression = (0, _shared_js_1.$assignmentExpression)(node.expression, this, ctx, -1);
    ...
    EvaluateLabelled(ctx, labelSet) {
        ...
        while (true) {
            ...
            const stmtResult = (0, _shared_js_1.evaluateStatement)(ctx, stmt);
            // 2. b. If LoopContinues(stmtResult, labelSet) is false, return Completion(UpdateEmpty(stmtResult, V)).
            if ((0, operations_js_1.$LoopContinues)(ctx, stmtResult, labelSet).isFalsey) {
...
class $WhileStatement {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.WhileStatement`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
...
class $ForStatement {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.ForStatement`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
        ...
        this.LexicallyDeclaredNames = kernel_1.emptyArray;
        this.LexicallyScopedDeclarations = kernel_1.emptyArray;
        this.$condition = (0, _shared_js_1.$assignmentExpression)(node.condition, this, ctx, -1);
        this.$incrementor = (0, _shared_js_1.$assignmentExpression)(node.incrementor, this, ctx, -1);
        const $statement = this.$statement = (0, _shared_js_1.$$esLabelledItem)(node.statement, this, ctx, -1);
...
class $ForInStatement {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.ForInStatement`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
...
class $ForOfStatement {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.ForOfStatement`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
...
class $ContinueStatement {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.ContinueStatement`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
        ...
        // 13.1.6 Static Semantics: VarScopedDeclarations
        this.VarScopedDeclarations = kernel_1.emptyArray;
        this.$label = (0, _shared_js_1.$identifier)(node.label, this, ctx | 2048 /* IsLabelReference */, -1);
    }
...
class $BreakStatement {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.BreakStatement`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
...
class $ReturnStatement {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.ReturnStatement`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
...
class $WithStatement {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.WithStatement`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
...
class $SwitchStatement {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.SwitchStatement`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
        ...
        const evaluateCaseClauses = (inclusiveStartIndex, exclusiveEndIndex, found = false) => {
            ...
            for (let i = inclusiveStartIndex; i < exclusiveEndIndex; i++) {
                ...
                if (found) {
                    ...
                    const R = (0, _shared_js_1.evaluateStatementList)(ctx, C.$statements);
...
class $LabeledStatement {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.LabeledStatement`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
        ...
        this.TypeDeclarations = kernel_1.emptyArray;
        this.IsType = false;
        this.$label = (0, _shared_js_1.$identifier)(node.label, this, ctx | 1024 /* IsLabel */, -1);
        const $statement = this.$statement = (0, _shared_js_1.$$esLabelledItem)(node.statement, this, ctx, -1);
...
class $ThrowStatement {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.ThrowStatement`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
...
class $TryStatement {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.TryStatement`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
...
class $DebuggerStatement {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.DebuggerStatement`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
...
class $CaseClause {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.CaseClause`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
...
class $DefaultClause {
    constructor(node, parent, ctx, idx, mos = parent.mos, realm = parent.realm, depth = parent.depth + 1, logger = parent.logger, path = `${parent.path}${(0, _shared_js_1.$i)(idx)}.DefaultClause`) {
        this.node = node;
        this.parent = parent;
        this.ctx = ctx;
        this.idx = idx;
