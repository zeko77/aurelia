...
class ServiceHost {
    ...
    ResolveImportedModule(ctx, referencingModule, $specifier) {
        const specifier = (0, path_utils_js_1.normalizePath)($specifier['[[Value]]']);
        const isRelative = (0, path_utils_js_1.isRelativeModulePath)(specifier);
        ...
        if (pkg === null) {
            ...
            const ext = '.js';
            const name = (0, path_1.basename)(specifier);
            const shortName = name.slice(0, -3);
            const path = (0, path_utils_js_1.joinPath)(dir, name);
        ...
        if (isRelative) {
            ...
            const filePath = (0, path_utils_js_1.resolvePath)((0, path_1.dirname)(referencingModule.$file.path), specifier);
            ...
            if (pkgDep === void 0) {
                ...
                if (pkgDep.refName !== specifier) {
                    ...
                    if (file === void 0) {
                        const indexModulePath = (0, path_utils_js_1.joinPath)(externalPkg.dir, 'index');
                        file = externalPkg.files.find(f => f.shortPath === indexModulePath && f.ext === '.js');
                        if (file === void 0) {
                            const partialAbsolutePath = (0, path_utils_js_1.joinPath)('node_modules', specifier);
    ...
    getESScript(ctx, file) {
        ...
        if (script === void 0) {
            const sourceText = file.getContentSync();
            const sf = (0, typescript_1.createSourceFile)(file.path, sourceText, typescript_1.ScriptTarget.Latest, false);
    ...
    getCompilerOptions(path, pkg) {
        ...
        path = (0, path_utils_js_1.normalizePath)(path);
        let compilerOptions = this.compilerOptionsCache.get(path);
        if (compilerOptions === void 0) {
            const dir = (0, path_utils_js_1.normalizePath)((0, path_1.dirname)(path));
            if (dir === path || pkg === null /* TODO: maybe still try to find tsconfig? */) {
                ...
                const tsConfigPath = (0, path_utils_js_1.joinPath)(path, 'tsconfig.json');
