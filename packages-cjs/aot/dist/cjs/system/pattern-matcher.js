...
class PatternMatcher {
    constructor(logger, compilerOptions) {
        ...
        this.rootDir = (0, path_utils_js_1.resolvePath)(compilerOptions.__dirname);
        this.basePath = (0, path_utils_js_1.joinPath)(this.rootDir, compilerOptions.baseUrl);
...
class PatternTarget {
    constructor(logger, source, pattern) {
        ...
        if (pattern.endsWith('*')) {
            this.hasWildcard = true;
            this.patternPath = (0, path_utils_js_1.joinPath)(source.matcher.basePath, pattern.slice(0, -1));
        }
        else {
            this.hasWildcard = false;
            this.patternPath = (0, path_utils_js_1.joinPath)(source.matcher.basePath, pattern);
        }
    }
    findMatch(files, specifier) {
        const targetPath = this.hasWildcard ? (0, path_utils_js_1.joinPath)(this.patternPath, specifier) : this.patternPath;
