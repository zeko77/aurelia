...
function preprocess(unit, options, _fileExists = fileExists) {
    ...
    const allOptions = (0, options_js_1.preprocessOptions)(options);
    ...
    if (allOptions.templateExtensions.includes(ext)) {
        ...
        return (0, preprocess_html_template_js_1.preprocessHtmlTemplate)(unit, allOptions);
    }
        ...
        return (0, preprocess_resource_js_1.preprocessResource)(unit, allOptions);
    }
}
