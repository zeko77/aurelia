...
function preprocessHtmlTemplate(unit, options) {
    const name = (0, resource_name_js_1.resourceName)(unit.path);
    const stripped = (0, strip_meta_data_js_1.stripMetaData)(unit.contents);
    ...
    const m = (0, modify_code_1.default)('', unit.path);
