...
function preprocessResource(unit, options) {
    const expectedResourceName = (0, resource_name_js_1.resourceName)(unit.path);
...
function modifyResource(unit, options) {
    ...
    const m = (0, modify_code_1.default)(unit.contents, unit.path);
...
function findResource(node, expectedResourceName, filePair, isViewPair, code) {
    ...
    const { name, type } = (0, name_convention_js_1.nameConvention)(className);
