...
describe('stripMetaData', function () {
    it('returns empty html', function () {
        testing_1.assert.deepEqual((0, plugin_conventions_1.stripMetaData)(' '), {
            aliases: [],
            html: ' ',
            shadowMode: null,
            deps: [],
...
`;
        testing_1.assert.deepEqual((0, plugin_conventions_1.stripMetaData)(html), {
            aliases: [],
            html: expected,
            shadowMode: null,
            deps: ['./a'],
...
`;
        testing_1.assert.deepEqual((0, plugin_conventions_1.stripMetaData)(html), {
            ...
            hasSlot: false,
            bindables: {
                firstName: { mode: runtime_1.BindingMode.toView },
                lastName: { mode: runtime_1.BindingMode.twoWay, attribute: 'surname' },
                foo: { mode: runtime_1.BindingMode.oneTime },
                bar: { mode: runtime_1.BindingMode.toView },
                lo: { mode: runtime_1.BindingMode.fromView }
            }
        });
    });
