...
`;
        const result = (0, plugin_conventions_1.preprocessHtmlTemplate)({ path: path.join('lo', 'foo-bar.html'), contents: html }, (0, plugin_conventions_1.preprocessOptions)());
...
`;
        const result = (0, plugin_conventions_1.preprocessHtmlTemplate)({ path: path.join('lo', 'foo-bar.html'), contents: html, filePair: 'foo-bar.css' }, (0, plugin_conventions_1.preprocessOptions)());
        testing_1.assert.equal(result.code, expected);
    });
...
`;
        const result = (0, plugin_conventions_1.preprocessHtmlTemplate)({ path: path.join('lo', 'FooBar.html'), contents: html }, (0, plugin_conventions_1.preprocessOptions)({ stringModuleWrap: (id) => `text!${id}` }));
        testing_1.assert.equal(result.code, expected);
    });
