...
import { $IteratorPrototype, $AsyncIteratorPrototype, $AsyncFromSyncIteratorPrototype } from './globals/iteration';
import { $StringConstructor, $StringPrototype } from './globals/string';
import { $ObjectConstructor, $ObjectPrototype, $ObjProto_toString } from './globals/object';
import { $FunctionPrototype, $FunctionConstructor } from './globals/function';
import { $NumberConstructor, $NumberPrototype } from './globals/number';
import { $BooleanConstructor, $BooleanPrototype } from './globals/boolean';
import { $SymbolConstructor, $SymbolPrototype } from './globals/symbol';
import { $ErrorConstructor, $ErrorPrototype, $EvalErrorConstructor, $EvalErrorPrototype, $RangeErrorConstructor, $RangeErrorPrototype, $ReferenceErrorConstructor, $ReferenceErrorPrototype, $SyntaxErrorConstructor, $SyntaxErrorPrototype, $TypeErrorConstructor, $TypeErrorPrototype, $URIErrorConstructor, $URIErrorPrototype } from './globals/error';
import { $ThrowTypeError } from './globals/throw-type-error';
import { IDisposable, Writable } from '@aurelia/kernel';
import { $GeneratorFunctionPrototype, $GeneratorPrototype, $GeneratorFunctionConstructor } from './globals/generator-function';
import { $PromiseConstructor, $PromisePrototype, $Promise_all, $Promise_resolve, $Promise_reject, $PromiseProto_then } from './globals/promise';
...
import { $ProxyConstructor } from './globals/proxy';
import { $Reflect } from './globals/reflect';
import { $Eval } from './globals/eval';
import { $IsFinite } from './globals/is-finite';
import { $IsNaN } from './globals/is-nan';
