...
import { IPlatform as d, bindable as f, INode as v, BindingMode as g, customAttribute as w, bindingBehavior as p, astEvaluator as b, BindingInterceptor as m, PropertyBinding as V, CustomElement as y } from "@aurelia/runtime-html";

import { IExpressionParser as C, connectable as E } from "@aurelia/runtime";
...
let U = class ValidateBindingBehavior extends m {
    ...
    h(t) {
        ...
        for (let t = 0, r = o.length; t < r; t++) {
            ...
            switch (t) {
              case 0:
                e = this.V(r.evaluate(i, this, this.triggerMediator));
                break;

              case 1:
                n = this.C(r.evaluate(i, this, this.controllerMediator));
                break;

              case 2:
                s = this.R(r.evaluate(i, this, this.rulesMediator));
                break;

              default:
                throw new Error(`Unconsumed argument#${t + 1} for validate binding behavior: ${r.evaluate(i, this, null)}`);
            }
        }
        return new ValidateArgumentsDelta(this.C(n), this.V(e), s);
    }
    validateBinding() {
        const t = this.task;
