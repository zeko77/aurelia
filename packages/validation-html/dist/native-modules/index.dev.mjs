...
import { IPlatform, bindable, INode, customAttribute, bindingBehavior, implementAstEvaluator, PropertyBinding, IFlushQueue, BindingTargetSubscriber, CustomElement } from '../../../runtime-html/dist/native-modules/index.mjs';
