...
import { IPlatform, bindable, INode, BindingMode, customAttribute, bindingBehavior, astEvaluator, BindingInterceptor, PropertyBinding, CustomElement } from '../../../runtime-html/dist/native-modules/index.mjs';
