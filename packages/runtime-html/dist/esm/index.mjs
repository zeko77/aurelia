...
class Controller {
    ...
    hS(t) {
        ...
        if (null !== (this.hostController = he.for(this.host, Ve))) {
            this.host = this.container.root.get(Jt).document.createElement(this.definition.name);
            if (r && null == o) o = this.location = Ss(this.host);
        }
