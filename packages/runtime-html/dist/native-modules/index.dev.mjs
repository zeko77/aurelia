import { Protocol, getPrototypeChain, firstDefined, kebabCase, noop, DI, Registration, emptyArray, all, mergeArrays, fromDefinitionOrDefault, pascalCase, fromAnnotationOrTypeOrDefault, fromAnnotationOrDefinitionOrTypeOrDefault, IPlatform as IPlatform$1, IContainer, optional, InstanceProvider, ILogger, resolveAll, onResolve, camelCase, toArray, emptyObject, IServiceLocator, transient } from '../../../kernel/dist/native-modules/index.mjs';
import { Metadata, isObject } from '../../../metadata/dist/native-modules/index.mjs';
import { subscriberCollection, astEvaluate, astBind, astUnbind, connectable, astAssign, ConnectableSwitcher, ProxyObservable, Scope, ICoercionConfiguration, IObserverLocator, IExpressionParser, AccessScopeExpression, PrimitiveLiteralExpression, ISignaler, PropertyAccessor, INodeObserverLocator, SetterObserver, IDirtyChecker, applyMutationsToIndices, getCollectionObserver as getCollectionObserver$1, synchronizeIndices, BindingContext } from '../../../runtime/dist/native-modules/index.mjs';
...
class AttributeBinding {
    ...
    $bind(scope) {
        ...
        if (this.mode & (2 | 1)) {
            this.updateTarget(this._value = astEvaluate(this.ast, scope, this, (this.mode & 2) > 0 ? this : null));
        }
        this.isBound = true;
    }
    $unbind() {
...
class InterpolationPartBinding {
    ...
    $bind(scope) {
        ...
        this.scope = scope;
        astBind(this.ast, scope, this);
        this._value = astEvaluate(this.ast, this.scope, this, (this.mode & 2) > 0 ? this : null);
...
class ContentBinding {
    ...
    handleCollectionChange() {
        ...
        this.obs.version++;
        const v = this._value = astEvaluate(this.ast, this.scope, this, (this.mode & 2) > 0 ? this : null);
        this.obs.clear();
        if (isArray(v)) {
...
class PropertyBinding {
    ...
    $bind(scope) {
        ...
        if ($mode & (2 | 1)) {
            this.updateTarget(astEvaluate(this.ast, this.scope, this, shouldConnect ? this : null));
        }
        if ($mode & 4) {
...
AttributeBindingRenderer.inject = [IPlatform, IExpressionParser, IObserverLocator];
...
class Repeat {
    ...
    _activateAllViews(initiator) {
        ...
        iterate(items, (item, i) => {
            ...
            if (this._hasDestructuredLocal) {
                astAssign(forOf.declaration, viewScope = Scope.fromParent(parentScope, new BindingContext()), this._forOfBinding, item);
            }
            else {
    ...
    _createAndActivateAndSortViewsByKey(oldLength, indexMap) {
        ...
        for (; i >= 0; --i) {
            ...
            if (indexMap[i] === -2) {
                if (this._hasDestructuredLocal) {
                    astAssign(this.forOf.declaration, viewScope = Scope.fromParent(parentScope, new BindingContext()), this._forOfBinding, normalizedItems[i]);
                }
                else {
