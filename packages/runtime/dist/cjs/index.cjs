...
class BindingBehaviorDefinition {
    ...
    static create(e, s) {
        ...
        return new BindingBehaviorDefinition(s, t.firstDefined(E(s, "name"), r), t.mergeArrays(E(s, "aliases"), i.aliases, s.aliases), A.keyFrom(r), t.fromAnnotationOrDefinitionOrTypeOrDefault("strategy", i, s, (() => o ? 2 : 1)));
    }
    register(e) {
...
class ValueConverterDefinition {
    ...
    static create(e, s) {
        ...
        return new ValueConverterDefinition(s, t.firstDefined(U(s, "name"), r), t.mergeArrays(U(s, "aliases"), i.aliases, s.aliases), S.keyFrom(r));
    }
    register(e) {
...
const R = t.DI.createInterface("ICoercionConfiguration");
