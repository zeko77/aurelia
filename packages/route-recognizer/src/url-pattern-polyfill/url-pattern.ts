...
import { Parser, URLPatternInit } from './url-pattern-parser';

export type URLPatternInput = Exclude<URLPatternInit, 'caseSensitivePath'>;
export type URLPatternKeys = Exclude<keyof URLPatternResult, 'inputs'>;
...
export class URLPattern {
  private readonly pattern: URLPatternInit;
  private readonly regexp: any = {};
  private readonly keys: any = {};
  private readonly component_pattern: any = {};

  public constructor(init: URLPatternInit | string = {}, baseURL: string | undefined = undefined) {
    try {
      // shorthand
  ...
  public test(input: string | URLPatternInput = {}, baseURL: string | undefined = undefined): boolean {
  ...
  public exec(input: string | URLPatternInput = {}, baseURL: string | undefined = undefined): URLPatternResult | null | undefined {
    let values: URLPatternInit = {
      pathname: '',
      protocol: '',
      username: '',
    ...
    if (typeof (input) !== 'string' && baseURL) {
      throw new TypeError(`Failed to execute 'exec' on 'URLPattern': Invalid second argument baseURL '${baseURL}' provided with a URLPatternInit input. Use the URLPatternInit.baseURL property instead.`);
    }
    ...
    const result: Partial<URLPatternResult> = { inputs: baseURL !== void 0 ? [input as string, baseURL] : [input as URLPatternInit] };
    let component: URLPatternKeys;
    for (component of COMPONENTS) {
