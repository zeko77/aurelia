...
const U = (t, e, r) => [ [ E, n ], [ "metadata", h ], [ "decorate", O ], [ "defineMetadata", p ], [ "hasMetadata", j ], [ "hasOwnMetadata", $ ], [ "getMetadata", F ], [ "getOwnMetadata", v ], [ "getMetadataKeys", K ], [ "getOwnMetadataKeys", m ], [ "deleteMetadata", x ] ].forEach((([n, a]) => R(t, n, a, e, r)));

const k = (t, e = true, r = false, a = true, o = true) => {
    if (S(t)) {
        if (t[E] === n) return;
