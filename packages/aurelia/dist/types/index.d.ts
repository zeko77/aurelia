...
export { CollectionKind, ComputedObserver, IObserverLocator, ISignaler, subscriberCollection, type BindingBehaviorInstance, observable, LifecycleFlags, type ValueConverterInstance, type IndexMap, } from '@aurelia/runtime';
