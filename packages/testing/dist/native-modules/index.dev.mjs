...
import { IObserverLocator, astEvaluate, astAssign, astBind, astUnbind, IDirtyChecker, INodeObserverLocator, Scope } from '../../../runtime/dist/native-modules/index.mjs';
...
class MockTracingExpression {
    ...
    evaluate(...args) {
        ...
        return astEvaluate(this.inner, ...args);
    }
    assign(...args) {
        this.trace('assign', ...args);
        return astAssign(this.inner, ...args);
    }
    bind(...args) {
        this.trace('bind', ...args);
        astBind(this.inner, ...args);
    }
    unbind(...args) {
        this.trace('unbind', ...args);
        astUnbind(this.inner, ...args);
    }
    accept(...args) {
