...
export declare class DialogService implements IDialogService {
    ...
    private get top();
    protected static get inject(): (import("@aurelia/kernel").InterfaceSymbol<IDialogGlobalSettings> | import("@aurelia/kernel").InterfaceSymbol<IPlatform> | import("@aurelia/kernel").InterfaceSymbol<IContainer>)[];
