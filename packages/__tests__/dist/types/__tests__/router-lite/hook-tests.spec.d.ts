...
declare abstract class TestVM implements IViewModel {
    ...
    load(p: P, n: RN, c: RN | null): void | Promise<void>;
    canUnload(n: RN | null, c: RN): boolean | Promise<boolean>;
    unload(n: RN | null, c: RN): void | Promise<void>;
    dispose(): void;
    ...
    protected $load(_p: P, _n: RN, _c: RN | null): void | Promise<void>;
    protected $canUnload(_n: RN | null, _c: RN): boolean | Promise<boolean>;
    protected $unload(_n: RN | null, _c: RN): void | Promise<void>;
