...
import { IDirtyChecker, IObserverLocator, INodeObserverLocator, ComputedObserver } from '@aurelia/runtime';
...
describe('[UNIT] 2-runtime/computed-observer.spec.ts', function () {
    ...
    eachCartesianJoin([propSpecs, depSpecs], (propSpec, depSpec) => {
        it(`propSpec ${propSpec.t}, depSpec ${depSpec.t}`, function () {
            ...
            let oldValue1;
            const subscriber1 = {
                handleChange($newValue, $oldValue, _flags) {
    ...
    it(`complex nested dependencies`, function () {
        ...
        class Foo {
            ...
            get getter() {
                const array = this[`array${this.branch}`];
                const set = this[`set${this.branch}`];
                const map = this[`map${this.branch}`];
                const obj = this[`obj${this.branch}`];
        ...
        let oldValue1;
        const subscriber1 = {
            handleChange($newValue, $oldValue, _$flags) {
