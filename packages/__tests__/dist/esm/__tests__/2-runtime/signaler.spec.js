...
import { MockPropertySubscriber, eachCartesianJoinFactory, assert, } from '@aurelia/testing';
...
describe('ISignaler', function () {
    ...
    const flagsVariations = [
        () => {
            const flags = undefined;
            return [`undefined`, flags];
        },
    ];
    const addSignalVariations = [
    ...
    const dispatchSignalVariations = [
    ...
    const inputs = [sutVariations, signalsVariations, flagsVariations, addSignalVariations, dispatchSignalVariations, removeSignalVariations];
...
//# sourceMappingURL=signaler.spec.js.map