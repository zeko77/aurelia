...
export async function createFixture(Component, deps = [], createHIAConfig = null, createRouterOptions = null, level = 3 /* warn */) {
    ...
    container.register(LoggerConfiguration.create({ sinks: [ConsoleSink], level: 3 /* warn */ }));
...
export async function clearBrowserState(platform, router = null) {
    ...
    if (index >= 0) {
        if (((_a = router === null || router === void 0 ? void 0 : router.viewer) === null || _a === void 0 ? void 0 : _a.replaceNavigatorState) == null) {
