...
describe('RoutingInstruction parsing', function () {
    ...
    describe('can handle routing instructions', function () {
        ...
        function assertError(error, type, msg) {
            let errMsg;
            switch (type) {
                case 'error:siblings':
        ...
        for (const test of instructions) {
            ...
            it(`parses routing instruction: ${instruction} => ${clean !== null && clean !== void 0 ? clean : routingInstruction}`, async function () {
                ...
                if (error === '') {
                    ...
                    // }
                    assert.strictEqual(newInstruction, clean !== null && clean !== void 0 ? clean : routingInstruction, `newInstruction`);
                }
                else {
                    // console.log(error);
                    if (clean == null) {
                    ...
                    assertError(error, clean !== null && clean !== void 0 ? clean : routingInstruction, instruction);
                }
                await tearDown();
            });
        }
...
//# sourceMappingURL=instruction-parser.spec.js.map