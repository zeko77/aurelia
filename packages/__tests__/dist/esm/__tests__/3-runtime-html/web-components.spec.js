...
describe('3-runtime-html/web-components.spec.ts', function () {
    ...
    describe('define', function () {
        it('throws on invalid WC element name', async function () {
            const { container, startPromise, tearDown } = createFixture(`<my-element>`, class App {
            });
            await startPromise;
        ...
        it('works with basic plain class', async function () {
            var _a;
            const { container, appHost, startPromise, tearDown } = createFixture(`<my-element>`, class App {
            });
            await startPromise;
        ...
        it('works with literal object element definition', async function () {
            const { container, appHost, startPromise, tearDown } = createFixture(`<my-element-1>`, class App {
            });
            await startPromise;
        ...
        it('works with Au custom element class', async function () {
            const { container, appHost, startPromise, tearDown } = createFixture(`<my-element-2>`, class App {
            });
            await startPromise;
        ...
        it('extends built-in elemenet', async function () {
            const { container, appHost, startPromise, tearDown } = createFixture(`<button is="my-btn-1">`, class App {
            });
            await startPromise;
        ...
        it('observes attribute on normal custom element', async function () {
            var _a;
            const { platform, container, appHost, component, startPromise, tearDown } = createFixture(`<my-element-3 message.attr="message">`, class App {
                constructor() {
                    this.message = 'hello world';
                }
            });
        ...
        it('observes attribute on extended built-in custom element', async function () {
            var _a;
            const { platform, container, appHost, component, startPromise, tearDown } = createFixture(`<p is="my-element-4" message.attr="message">`, class App {
                constructor() {
                    this.message = 'hello world';
                }
            });
        ...
        it('works with bindable-as-property on normal custom element', async function () {
            var _a;
            const { platform, container, appHost, startPromise, tearDown } = createFixture(`<my-element-5 message.attr="message">`, class App {
                constructor() {
                    this.message = 'hello world';
                }
            });
    ...
    describe('disconnectedCallback()', function () {
        it('deactivate controller', async function () {
            var _a;
            const { container, appHost, startPromise, tearDown } = createFixture(`<my-element-20>`, class App {
            });
            await startPromise;
