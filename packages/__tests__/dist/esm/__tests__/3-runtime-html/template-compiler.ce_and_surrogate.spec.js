...
import { CustomElement, Aurelia, CustomAttribute } from '@aurelia/runtime-html';
describe('3-runtime-html/template-compiler.ce_and_surrogate.spec.ts', function () {
    ...
    for (const testCase of testCases) {
        const { title, template, root, resources = [], assertFn } = testCase;
        it(title, async function () {
            ...
            try {
                ...
                const Root = CustomElement.define({ name: 'app', template }, root === undefined ? class App {
                } : root);
...
//# sourceMappingURL=template-compiler.ce_and_surrogate.spec.js.map