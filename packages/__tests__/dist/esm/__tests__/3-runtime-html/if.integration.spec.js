...
describe(`3-runtime-html/if.integration.spec.ts`, function () {
    ...
    eachCartesianJoin([duplicateOperationSpecs, bindSpecs, mutationSpecs, flagsSpecs], (duplicateOperationSpec, bindSpec, mutationSpec, flagsSpec) => {
        it(`verify if/else behavior - duplicateOperationSpec ${duplicateOperationSpec.t}, bindSpec ${bindSpec.t}, mutationSpec ${mutationSpec.t}, flagsSpec ${flagsSpec.t}, `, function () {
            ...
            const ifLoc = PLATFORM.document.createComment('au-end');
            const elseLoc = PLATFORM.document.createComment('au-end');
            ...
            const ifController = sut.$controller = Controller.$attr(container, sut, (void 0));
            elseSut.link({ children: [ifController] }, void 0, void 0, void 0);
            const firstBindInitialNodesText = value1 ? ifText : elseText;
            const firstBindFinalNodesText = firstBindInitialNodesText;
            const firstAttachInitialHostText = value1 ? ifText : elseText;
            const firstAttachFinalHostText = newValue1 ? ifText : elseText;
            const secondBindInitialNodesText = value2 ? ifText : elseText;
            const secondBindFinalNodesText = secondBindInitialNodesText;
            const secondAttachInitialHostText = value2 ? ifText : elseText;
            const secondAttachFinalHostText = newValue2 ? ifText : elseText;
            // -- Round 1 --
