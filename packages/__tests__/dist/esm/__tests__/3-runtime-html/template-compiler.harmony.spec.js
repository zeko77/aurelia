    ...
    const testCases = [
        ...
        },
        {
            ...
            assertFn: (ctx, host) => {
                ...
                const $ceViewModel = CustomElement.for(ceEl).viewModel;
        ...
        ...Array.from({ length: 10 }, (_, idx) => {
            ...
            return {
                ...
                assertFn: (ctx, host) => {
                    ...
                    const leafCeHost = host.querySelector(`[lvl=lvl-${idx}]`);
                    const $leafCeVm = CustomElement.for(leafCeHost).viewModel;
        ...
        },
        {
            ...
            resources: [
                CustomAttribute.define({ name: 'aaabbb', bindables: ['value'] }, (_a = class AB {
                        constructor(element) {
      ...
      `,
            resources: [
                CustomAttribute.define({ name: 'click', bindables: ['value'] }, (_b = class Click {
                        constructor(element) {
                            this.element = element;
                        }
                        binding() {
