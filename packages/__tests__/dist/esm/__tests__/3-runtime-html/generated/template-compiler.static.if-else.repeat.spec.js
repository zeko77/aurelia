...
describe("generated.template-compiler.static.if-else.repeat", function () {
    ...
    it("tag$01 text$01 if$01 repeat$11 variant$01 _", function () {
        ...
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 1\"><div if.bind=\"true\">a</div><div else>b</div></div></template>" }, class {
        });
    ...
    it("tag$01 text$01 if$01 repeat$11 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\"><div repeat.for=\"i of 1\">a</div></div><div else><div repeat.for=\"i of 1\">b</div></div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "a");
    ...
    it("tag$01 text$01 if$01 repeat$11 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\" repeat.for=\"i of 1\">a</div><div else repeat.for=\"i of 1\">b</div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "a");
    ...
    it("tag$01 text$01 if$01 repeat$11 variant$04 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 1\"><div if.bind=\"true\">a</div></div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "a");
    ...
    it("tag$01 text$01 if$01 repeat$11 variant$05 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 1\" if.bind=\"true\">a</div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "a");
    ...
    it("tag$01 text$01 if$01 repeat$11 variant$06 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\"><div repeat.for=\"i of 1\">a</div></div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "a");
    ...
    it("tag$01 text$01 if$01 repeat$11 variant$07 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\" repeat.for=\"i of 1\">a</div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "a");
    ...
    it("tag$01 text$01 if$01 repeat$11 variant$08$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 1\"><div if.bind=\"true\">a</div><div else></div></div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "a");
    ...
    it("tag$01 text$01 if$01 repeat$11 variant$09 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\"><div repeat.for=\"i of 1\">a</div></div><div else><div repeat.for=\"i of 1\">a</div></div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "a");
    ...
    it("tag$01 text$01 if$01 repeat$11 variant$09$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\"><div repeat.for=\"i of 1\">a</div></div><div else></div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "a");
    ...
    it("tag$01 text$01 if$01 repeat$12 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 3\"><div if.bind=\"true\">a</div><div else>b</div></div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "aaa");
    ...
    it("tag$01 text$01 if$01 repeat$12 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\"><div repeat.for=\"i of 3\">a</div></div><div else><div repeat.for=\"i of 3\">b</div></div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "aaa");
    ...
    it("tag$01 text$01 if$01 repeat$12 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\" repeat.for=\"i of 3\">a</div><div else repeat.for=\"i of 3\">b</div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "aaa");
    ...
    it("tag$01 text$01 if$01 repeat$12 variant$04 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 3\"><div if.bind=\"true\">a</div></div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "aaa");
    ...
    it("tag$01 text$01 if$01 repeat$12 variant$05 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 3\" if.bind=\"true\">a</div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "aaa");
    ...
    it("tag$01 text$01 if$01 repeat$12 variant$06 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\"><div repeat.for=\"i of 3\">a</div></div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "aaa");
    ...
    it("tag$01 text$01 if$01 repeat$12 variant$07 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\" repeat.for=\"i of 3\">a</div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "aaa");
    ...
    it("tag$01 text$01 if$01 repeat$12 variant$08$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 3\"><div if.bind=\"true\">a</div><div else></div></div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "aaa");
    ...
    it("tag$01 text$01 if$01 repeat$12 variant$09 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\"><div repeat.for=\"i of 3\">a</div></div><div else><div repeat.for=\"i of 3\">a</div></div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "aaa");
    ...
    it("tag$01 text$01 if$01 repeat$12 variant$09$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\"><div repeat.for=\"i of 3\">a</div></div><div else></div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "aaa");
    ...
    it("tag$01 text$01 if$02 repeat$11 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 1\"><div if.bind=\"false\">a</div><div else>b</div></div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "b");
    ...
    it("tag$01 text$01 if$02 repeat$11 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\"><div repeat.for=\"i of 1\">a</div></div><div else><div repeat.for=\"i of 1\">b</div></div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "b");
    ...
    it("tag$01 text$01 if$02 repeat$11 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\" repeat.for=\"i of 1\">a</div><div else repeat.for=\"i of 1\">b</div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "b");
    ...
    it("tag$01 text$01 if$02 repeat$11 variant$10$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 1\"><div if.bind=\"false\"></div><div else>b</div></div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "b");
    ...
    it("tag$01 text$01 if$02 repeat$11 variant$11 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\">a</div><div else><div repeat.for=\"i of 1\">b</div></div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "b");
    ...
    it("tag$01 text$01 if$02 repeat$11 variant$11$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\"></div><div else><div repeat.for=\"i of 1\">b</div></div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "b");
    ...
    it("tag$01 text$01 if$02 repeat$11 variant$12 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\">a</div><div else repeat.for=\"i of 1\">b</div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "b");
    ...
    it("tag$01 text$01 if$02 repeat$12 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 3\"><div if.bind=\"false\">a</div><div else>b</div></div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "bbb");
    ...
    it("tag$01 text$01 if$02 repeat$12 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\"><div repeat.for=\"i of 3\">a</div></div><div else><div repeat.for=\"i of 3\">b</div></div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "bbb");
    ...
    it("tag$01 text$01 if$02 repeat$12 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\" repeat.for=\"i of 3\">a</div><div else repeat.for=\"i of 3\">b</div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "bbb");
    ...
    it("tag$01 text$01 if$02 repeat$12 variant$10$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 3\"><div if.bind=\"false\"></div><div else>b</div></div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "bbb");
    ...
    it("tag$01 text$01 if$02 repeat$12 variant$11 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\">a</div><div else><div repeat.for=\"i of 3\">b</div></div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "bbb");
    ...
    it("tag$01 text$01 if$02 repeat$12 variant$11$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\"></div><div else><div repeat.for=\"i of 3\">b</div></div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "bbb");
    ...
    it("tag$01 text$01 if$02 repeat$12 variant$12 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\">a</div><div else repeat.for=\"i of 3\">b</div></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "bbb");
    ...
    it("tag$01 text$02 if$01 repeat$11 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 1\"><div if.bind=\"true\">a</div><div else>${not}</div></div></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$01 text$02 if$01 repeat$11 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\"><div repeat.for=\"i of 1\">a</div></div><div else><div repeat.for=\"i of 1\">${not}</div></div></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$01 text$02 if$01 repeat$11 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\" repeat.for=\"i of 1\">a</div><div else repeat.for=\"i of 1\">${not}</div></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$01 text$02 if$01 repeat$12 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 3\"><div if.bind=\"true\">a</div><div else>${not}</div></div></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$01 text$02 if$01 repeat$12 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\"><div repeat.for=\"i of 3\">a</div></div><div else><div repeat.for=\"i of 3\">${not}</div></div></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$01 text$02 if$01 repeat$12 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\" repeat.for=\"i of 3\">a</div><div else repeat.for=\"i of 3\">${not}</div></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$01 text$02 if$02 repeat$11 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 1\"><div if.bind=\"false\">a</div><div else>${not}</div></div></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$01 text$02 if$02 repeat$11 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\"><div repeat.for=\"i of 1\">a</div></div><div else><div repeat.for=\"i of 1\">${not}</div></div></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$01 text$02 if$02 repeat$11 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\" repeat.for=\"i of 1\">a</div><div else repeat.for=\"i of 1\">${not}</div></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$01 text$02 if$02 repeat$11 variant$10$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 1\"><div if.bind=\"false\"></div><div else>${not}</div></div></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$01 text$02 if$02 repeat$11 variant$11 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\">a</div><div else><div repeat.for=\"i of 1\">${not}</div></div></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$01 text$02 if$02 repeat$11 variant$11$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\"></div><div else><div repeat.for=\"i of 1\">${not}</div></div></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$01 text$02 if$02 repeat$11 variant$12 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\">a</div><div else repeat.for=\"i of 1\">${not}</div></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$01 text$02 if$02 repeat$12 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 3\"><div if.bind=\"false\">a</div><div else>${not}</div></div></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$01 text$02 if$02 repeat$12 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\"><div repeat.for=\"i of 3\">a</div></div><div else><div repeat.for=\"i of 3\">${not}</div></div></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$01 text$02 if$02 repeat$12 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\" repeat.for=\"i of 3\">a</div><div else repeat.for=\"i of 3\">${not}</div></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$01 text$02 if$02 repeat$12 variant$10$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 3\"><div if.bind=\"false\"></div><div else>${not}</div></div></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$01 text$02 if$02 repeat$12 variant$11 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\">a</div><div else><div repeat.for=\"i of 3\">${not}</div></div></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$01 text$02 if$02 repeat$12 variant$11$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\"></div><div else><div repeat.for=\"i of 3\">${not}</div></div></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$01 text$02 if$02 repeat$12 variant$12 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\">a</div><div else repeat.for=\"i of 3\">${not}</div></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$01 text$03 if$01 repeat$11 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 1\"><div if.bind=\"true\">${msg}</div><div else>${not}</div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$11 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\"><div repeat.for=\"i of 1\">${msg}</div></div><div else><div repeat.for=\"i of 1\">${not}</div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$11 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\" repeat.for=\"i of 1\">${msg}</div><div else repeat.for=\"i of 1\">${not}</div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$11 variant$04 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 1\"><div if.bind=\"true\">${msg}</div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$11 variant$05 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 1\" if.bind=\"true\">${msg}</div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$11 variant$06 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\"><div repeat.for=\"i of 1\">${msg}</div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$11 variant$07 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\" repeat.for=\"i of 1\">${msg}</div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$11 variant$08$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 1\"><div if.bind=\"true\">${msg}</div><div else></div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$11 variant$09 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\"><div repeat.for=\"i of 1\">${msg}</div></div><div else><div repeat.for=\"i of 1\">${msg}</div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$11 variant$09$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\"><div repeat.for=\"i of 1\">${msg}</div></div><div else></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$12 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 3\"><div if.bind=\"true\">${msg}</div><div else>${not}</div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$12 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\"><div repeat.for=\"i of 3\">${msg}</div></div><div else><div repeat.for=\"i of 3\">${not}</div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$12 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\" repeat.for=\"i of 3\">${msg}</div><div else repeat.for=\"i of 3\">${not}</div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$12 variant$04 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 3\"><div if.bind=\"true\">${msg}</div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$12 variant$05 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 3\" if.bind=\"true\">${msg}</div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$12 variant$06 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\"><div repeat.for=\"i of 3\">${msg}</div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$12 variant$07 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\" repeat.for=\"i of 3\">${msg}</div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$12 variant$08$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 3\"><div if.bind=\"true\">${msg}</div><div else></div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$12 variant$09 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\"><div repeat.for=\"i of 3\">${msg}</div></div><div else><div repeat.for=\"i of 3\">${msg}</div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$12 variant$09$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\"><div repeat.for=\"i of 3\">${msg}</div></div><div else></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$13 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"item of ['a', 'b', 'c']\"><div if.bind=\"true\">${item}</div><div else>${item}</div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$13 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\"><div repeat.for=\"item of ['a', 'b', 'c']\">${item}</div></div><div else><div repeat.for=\"item of ['a', 'b', 'c']\">${item}</div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$13 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\" repeat.for=\"item of ['a', 'b', 'c']\">${item}</div><div else repeat.for=\"item of ['a', 'b', 'c']\">${item}</div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$13 variant$04 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"item of ['a', 'b', 'c']\"><div if.bind=\"true\">${item}</div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$13 variant$05 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"item of ['a', 'b', 'c']\" if.bind=\"true\">${item}</div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$13 variant$06 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\"><div repeat.for=\"item of ['a', 'b', 'c']\">${item}</div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$13 variant$07 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\" repeat.for=\"item of ['a', 'b', 'c']\">${item}</div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$13 variant$08$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"item of ['a', 'b', 'c']\"><div if.bind=\"true\">${item}</div><div else></div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$01 repeat$13 variant$09$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"true\"><div repeat.for=\"item of ['a', 'b', 'c']\">${item}</div></div><div else></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$02 repeat$11 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 1\"><div if.bind=\"false\">${msg}</div><div else>${not}</div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$02 repeat$11 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\"><div repeat.for=\"i of 1\">${msg}</div></div><div else><div repeat.for=\"i of 1\">${not}</div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$02 repeat$11 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\" repeat.for=\"i of 1\">${msg}</div><div else repeat.for=\"i of 1\">${not}</div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$02 repeat$11 variant$11 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\">${msg}</div><div else><div repeat.for=\"i of 1\">${not}</div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$02 repeat$11 variant$12 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\">${msg}</div><div else repeat.for=\"i of 1\">${not}</div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$02 repeat$12 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"i of 3\"><div if.bind=\"false\">${msg}</div><div else>${not}</div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$02 repeat$12 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\"><div repeat.for=\"i of 3\">${msg}</div></div><div else><div repeat.for=\"i of 3\">${not}</div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$02 repeat$12 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\" repeat.for=\"i of 3\">${msg}</div><div else repeat.for=\"i of 3\">${not}</div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$02 repeat$12 variant$11 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\">${msg}</div><div else><div repeat.for=\"i of 3\">${not}</div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$02 repeat$12 variant$12 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\">${msg}</div><div else repeat.for=\"i of 3\">${not}</div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$02 repeat$13 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"item of ['a', 'b', 'c']\"><div if.bind=\"false\">${item}</div><div else>${item}</div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$02 repeat$13 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\"><div repeat.for=\"item of ['a', 'b', 'c']\">${item}</div></div><div else><div repeat.for=\"item of ['a', 'b', 'c']\">${item}</div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$02 repeat$13 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\" repeat.for=\"item of ['a', 'b', 'c']\">${item}</div><div else repeat.for=\"item of ['a', 'b', 'c']\">${item}</div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$02 repeat$13 variant$10$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div repeat.for=\"item of ['a', 'b', 'c']\"><div if.bind=\"false\"></div><div else>${item}</div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$02 repeat$13 variant$11 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\">${item}</div><div else><div repeat.for=\"item of ['a', 'b', 'c']\">${item}</div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$02 repeat$13 variant$11$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\"></div><div else><div repeat.for=\"item of ['a', 'b', 'c']\">${item}</div></div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$01 text$03 if$02 repeat$13 variant$12 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><div if.bind=\"false\">${item}</div><div else repeat.for=\"item of ['a', 'b', 'c']\">${item}</div></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$01 if$01 repeat$11 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 1\"><template if.bind=\"true\">a</template><template else>b</template></template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "a");
    ...
    it("tag$02 text$01 if$01 repeat$11 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 1\">a</template></template><template else><template repeat.for=\"i of 1\">b</template></template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "a");
    ...
    it("tag$02 text$01 if$01 repeat$11 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\" repeat.for=\"i of 1\">a</template><template else repeat.for=\"i of 1\">b</template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "a");
    ...
    it("tag$02 text$01 if$01 repeat$11 variant$04 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 1\"><template if.bind=\"true\">a</template></template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "a");
    ...
    it("tag$02 text$01 if$01 repeat$11 variant$05 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 1\" if.bind=\"true\">a</template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "a");
    ...
    it("tag$02 text$01 if$01 repeat$11 variant$06 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 1\">a</template></template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "a");
    ...
    it("tag$02 text$01 if$01 repeat$11 variant$07 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\" repeat.for=\"i of 1\">a</template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "a");
    ...
    it("tag$02 text$01 if$01 repeat$11 variant$08$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 1\"><template if.bind=\"true\">a</template><template else></template></template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "a");
    ...
    it("tag$02 text$01 if$01 repeat$11 variant$09 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 1\">a</template></template><template else><template repeat.for=\"i of 1\">a</template></template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "a");
    ...
    it("tag$02 text$01 if$01 repeat$11 variant$09$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 1\">a</template></template><template else></template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "a");
    ...
    it("tag$02 text$01 if$01 repeat$12 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 3\"><template if.bind=\"true\">a</template><template else>b</template></template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "aaa");
    ...
    it("tag$02 text$01 if$01 repeat$12 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 3\">a</template></template><template else><template repeat.for=\"i of 3\">b</template></template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "aaa");
    ...
    it("tag$02 text$01 if$01 repeat$12 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\" repeat.for=\"i of 3\">a</template><template else repeat.for=\"i of 3\">b</template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "aaa");
    ...
    it("tag$02 text$01 if$01 repeat$12 variant$04 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 3\"><template if.bind=\"true\">a</template></template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "aaa");
    ...
    it("tag$02 text$01 if$01 repeat$12 variant$05 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 3\" if.bind=\"true\">a</template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "aaa");
    ...
    it("tag$02 text$01 if$01 repeat$12 variant$06 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 3\">a</template></template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "aaa");
    ...
    it("tag$02 text$01 if$01 repeat$12 variant$07 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\" repeat.for=\"i of 3\">a</template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "aaa");
    ...
    it("tag$02 text$01 if$01 repeat$12 variant$08$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 3\"><template if.bind=\"true\">a</template><template else></template></template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "aaa");
    ...
    it("tag$02 text$01 if$01 repeat$12 variant$09 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 3\">a</template></template><template else><template repeat.for=\"i of 3\">a</template></template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "aaa");
    ...
    it("tag$02 text$01 if$01 repeat$12 variant$09$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 3\">a</template></template><template else></template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "aaa");
    ...
    it("tag$02 text$01 if$02 repeat$11 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 1\"><template if.bind=\"false\">a</template><template else>b</template></template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "b");
    ...
    it("tag$02 text$01 if$02 repeat$11 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\"><template repeat.for=\"i of 1\">a</template></template><template else><template repeat.for=\"i of 1\">b</template></template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "b");
    ...
    it("tag$02 text$01 if$02 repeat$11 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\" repeat.for=\"i of 1\">a</template><template else repeat.for=\"i of 1\">b</template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "b");
    ...
    it("tag$02 text$01 if$02 repeat$11 variant$10$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 1\"><template if.bind=\"false\"></template><template else>b</template></template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "b");
    ...
    it("tag$02 text$01 if$02 repeat$11 variant$11 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\">a</template><template else><template repeat.for=\"i of 1\">b</template></template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "b");
    ...
    it("tag$02 text$01 if$02 repeat$11 variant$11$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\"></template><template else><template repeat.for=\"i of 1\">b</template></template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "b");
    ...
    it("tag$02 text$01 if$02 repeat$11 variant$12 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\">a</template><template else repeat.for=\"i of 1\">b</template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "b");
    ...
    it("tag$02 text$01 if$02 repeat$12 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 3\"><template if.bind=\"false\">a</template><template else>b</template></template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "bbb");
    ...
    it("tag$02 text$01 if$02 repeat$12 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\"><template repeat.for=\"i of 3\">a</template></template><template else><template repeat.for=\"i of 3\">b</template></template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "bbb");
    ...
    it("tag$02 text$01 if$02 repeat$12 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\" repeat.for=\"i of 3\">a</template><template else repeat.for=\"i of 3\">b</template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "bbb");
    ...
    it("tag$02 text$01 if$02 repeat$12 variant$10$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 3\"><template if.bind=\"false\"></template><template else>b</template></template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "bbb");
    ...
    it("tag$02 text$01 if$02 repeat$12 variant$11 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\">a</template><template else><template repeat.for=\"i of 3\">b</template></template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "bbb");
    ...
    it("tag$02 text$01 if$02 repeat$12 variant$11$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\"></template><template else><template repeat.for=\"i of 3\">b</template></template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "bbb");
    ...
    it("tag$02 text$01 if$02 repeat$12 variant$12 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\">a</template><template else repeat.for=\"i of 3\">b</template></template>" }, class {
        });
        const component = new App();
        au.app({ host, component });
        verify(au, host, "bbb");
    ...
    it("tag$02 text$02 if$01 repeat$11 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 1\"><template if.bind=\"true\">a</template><template else>${not}</template></template></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$02 text$02 if$01 repeat$11 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 1\">a</template></template><template else><template repeat.for=\"i of 1\">${not}</template></template></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$02 text$02 if$01 repeat$11 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\" repeat.for=\"i of 1\">a</template><template else repeat.for=\"i of 1\">${not}</template></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$02 text$02 if$01 repeat$12 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 3\"><template if.bind=\"true\">a</template><template else>${not}</template></template></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$02 text$02 if$01 repeat$12 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 3\">a</template></template><template else><template repeat.for=\"i of 3\">${not}</template></template></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$02 text$02 if$01 repeat$12 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\" repeat.for=\"i of 3\">a</template><template else repeat.for=\"i of 3\">${not}</template></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$02 text$02 if$02 repeat$11 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 1\"><template if.bind=\"false\">a</template><template else>${not}</template></template></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$02 text$02 if$02 repeat$11 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\"><template repeat.for=\"i of 1\">a</template></template><template else><template repeat.for=\"i of 1\">${not}</template></template></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$02 text$02 if$02 repeat$11 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\" repeat.for=\"i of 1\">a</template><template else repeat.for=\"i of 1\">${not}</template></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$02 text$02 if$02 repeat$11 variant$10$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 1\"><template if.bind=\"false\"></template><template else>${not}</template></template></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$02 text$02 if$02 repeat$11 variant$11 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\">a</template><template else><template repeat.for=\"i of 1\">${not}</template></template></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$02 text$02 if$02 repeat$11 variant$11$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\"></template><template else><template repeat.for=\"i of 1\">${not}</template></template></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$02 text$02 if$02 repeat$11 variant$12 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\">a</template><template else repeat.for=\"i of 1\">${not}</template></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$02 text$02 if$02 repeat$12 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 3\"><template if.bind=\"false\">a</template><template else>${not}</template></template></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$02 text$02 if$02 repeat$12 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\"><template repeat.for=\"i of 3\">a</template></template><template else><template repeat.for=\"i of 3\">${not}</template></template></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$02 text$02 if$02 repeat$12 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\" repeat.for=\"i of 3\">a</template><template else repeat.for=\"i of 3\">${not}</template></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$02 text$02 if$02 repeat$12 variant$10$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 3\"><template if.bind=\"false\"></template><template else>${not}</template></template></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$02 text$02 if$02 repeat$12 variant$11 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\">a</template><template else><template repeat.for=\"i of 3\">${not}</template></template></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$02 text$02 if$02 repeat$12 variant$11$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\"></template><template else><template repeat.for=\"i of 3\">${not}</template></template></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$02 text$02 if$02 repeat$12 variant$12 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\">a</template><template else repeat.for=\"i of 3\">${not}</template></template>" }, class {
            constructor() {
                this.not = "b";
            }
        });
    ...
    it("tag$02 text$03 if$01 repeat$11 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 1\"><template if.bind=\"true\">${msg}</template><template else>${not}</template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$11 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 1\">${msg}</template></template><template else><template repeat.for=\"i of 1\">${not}</template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$11 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\" repeat.for=\"i of 1\">${msg}</template><template else repeat.for=\"i of 1\">${not}</template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$11 variant$04 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 1\"><template if.bind=\"true\">${msg}</template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$11 variant$05 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 1\" if.bind=\"true\">${msg}</template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$11 variant$06 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 1\">${msg}</template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$11 variant$07 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\" repeat.for=\"i of 1\">${msg}</template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$11 variant$08$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 1\"><template if.bind=\"true\">${msg}</template><template else></template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$11 variant$09 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 1\">${msg}</template></template><template else><template repeat.for=\"i of 1\">${msg}</template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$11 variant$09$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 1\">${msg}</template></template><template else></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$12 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 3\"><template if.bind=\"true\">${msg}</template><template else>${not}</template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$12 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 3\">${msg}</template></template><template else><template repeat.for=\"i of 3\">${not}</template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$12 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\" repeat.for=\"i of 3\">${msg}</template><template else repeat.for=\"i of 3\">${not}</template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$12 variant$04 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 3\"><template if.bind=\"true\">${msg}</template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$12 variant$05 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 3\" if.bind=\"true\">${msg}</template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$12 variant$06 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 3\">${msg}</template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$12 variant$07 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\" repeat.for=\"i of 3\">${msg}</template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$12 variant$08$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 3\"><template if.bind=\"true\">${msg}</template><template else></template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$12 variant$09 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 3\">${msg}</template></template><template else><template repeat.for=\"i of 3\">${msg}</template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$12 variant$09$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 3\">${msg}</template></template><template else></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$13 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"item of ['a', 'b', 'c']\"><template if.bind=\"true\">${item}</template><template else>${item}</template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$13 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"item of ['a', 'b', 'c']\">${item}</template></template><template else><template repeat.for=\"item of ['a', 'b', 'c']\">${item}</template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$13 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\" repeat.for=\"item of ['a', 'b', 'c']\">${item}</template><template else repeat.for=\"item of ['a', 'b', 'c']\">${item}</template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$13 variant$04 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"item of ['a', 'b', 'c']\"><template if.bind=\"true\">${item}</template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$13 variant$05 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"item of ['a', 'b', 'c']\" if.bind=\"true\">${item}</template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$13 variant$06 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"item of ['a', 'b', 'c']\">${item}</template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$13 variant$07 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\" repeat.for=\"item of ['a', 'b', 'c']\">${item}</template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$13 variant$08$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"item of ['a', 'b', 'c']\"><template if.bind=\"true\">${item}</template><template else></template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$01 repeat$13 variant$09$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"item of ['a', 'b', 'c']\">${item}</template></template><template else></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$02 repeat$11 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 1\"><template if.bind=\"false\">${msg}</template><template else>${not}</template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$02 repeat$11 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\"><template repeat.for=\"i of 1\">${msg}</template></template><template else><template repeat.for=\"i of 1\">${not}</template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$02 repeat$11 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\" repeat.for=\"i of 1\">${msg}</template><template else repeat.for=\"i of 1\">${not}</template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$02 repeat$11 variant$11 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\">${msg}</template><template else><template repeat.for=\"i of 1\">${not}</template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$02 repeat$11 variant$12 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\">${msg}</template><template else repeat.for=\"i of 1\">${not}</template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$02 repeat$12 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"i of 3\"><template if.bind=\"false\">${msg}</template><template else>${not}</template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$02 repeat$12 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\"><template repeat.for=\"i of 3\">${msg}</template></template><template else><template repeat.for=\"i of 3\">${not}</template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$02 repeat$12 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\" repeat.for=\"i of 3\">${msg}</template><template else repeat.for=\"i of 3\">${not}</template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$02 repeat$12 variant$11 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\">${msg}</template><template else><template repeat.for=\"i of 3\">${not}</template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$02 repeat$12 variant$12 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\">${msg}</template><template else repeat.for=\"i of 3\">${not}</template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$02 repeat$13 variant$01 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"item of ['a', 'b', 'c']\"><template if.bind=\"false\">${item}</template><template else>${item}</template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$02 repeat$13 variant$02 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\"><template repeat.for=\"item of ['a', 'b', 'c']\">${item}</template></template><template else><template repeat.for=\"item of ['a', 'b', 'c']\">${item}</template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$02 repeat$13 variant$03 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\" repeat.for=\"item of ['a', 'b', 'c']\">${item}</template><template else repeat.for=\"item of ['a', 'b', 'c']\">${item}</template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$02 repeat$13 variant$10$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template repeat.for=\"item of ['a', 'b', 'c']\"><template if.bind=\"false\"></template><template else>${item}</template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$02 repeat$13 variant$11 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\">${item}</template><template else><template repeat.for=\"item of ['a', 'b', 'c']\">${item}</template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$02 repeat$13 variant$11$empty _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\"></template><template else><template repeat.for=\"item of ['a', 'b', 'c']\">${item}</template></template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
    ...
    it("tag$02 text$03 if$02 repeat$13 variant$12 _", function () {
        const { au, host } = createFixture();
        const App = CustomElement.define({ name: "app", template: "<template><template if.bind=\"false\">${item}</template><template else repeat.for=\"item of ['a', 'b', 'c']\">${item}</template></template>" }, class {
            constructor() {
                this.msg = "a";
                this.not = "b";
            }
