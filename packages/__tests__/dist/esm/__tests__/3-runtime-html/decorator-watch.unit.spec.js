...
describe('3-runtime-html/decorator-watch.unit.spec.ts', function () {
    describe('ComputedWatcher', function () {
        it('works', function () {
            ...
            const obj = {};
            const watcher = new ComputedWatcher(obj, observerLocator, o => {
                getCallCount++;
                return o['prop'];
            }, (newValue) => {
        ...
        it('works with manual observation without proxy', function () {
            ...
            const observerLocator = createObserverLocator(container);
            const obj = {};
            const watcher = new ComputedWatcher(obj, observerLocator, (o, w) => {
                getCallCount++;
                w.observe(o, '_p');
                return o.prop;
            }, (newValue) => {
    ...
    describe('ExpressionWatcher', function () {
        it('observers', function () {
            ...
            const observerLocator = createObserverLocator(container);
            const obj = { a: {} };
            const expr = new AccessMemberExpression(new AccessScopeExpression('a'), 'prop');
...
//# sourceMappingURL=decorator-watch.unit.spec.js.map