...
describe('validation/validation.spec.ts/ValidationRules', function () {
    ...
    it('can be used to define validation rules fluently on string properties', function () {
        ...
        const [required, minLength, maxLength, matches] = phase1Rules;
        ...
        const [emailRule, equalRule] = phase2Rules;
    ...
    it('can be used to define validation rules fluently on number properties', function () {
        ...
        const [required, equalRule, ...rangeRules] = validationRules;
        assert.instanceOf(required, RequiredRule);
        assert.instanceOf(equalRule, EqualsRule);
    ...
    it('can be used to define validation rules fluently using lambda', function () {
        ...
        const rules = sut
            .ensure(propName)
            .satisfies((_value, _obj) => { executed = true; return 'foo' === 'bar'; })
            .rules;
        assert.equal(rules.length, 1);
        const propertyRule = rules[0];
        assert.instanceOf(propertyRule, PropertyRule);
    ...
    it('can be used to define validation rules on different properties', function () {
        ...
        assert.equal(rule1.property.name, 'name');
        ...
        assert.equal(rule2.property.name, 'age');
    ...
    it('can define rules on multiple objects', function () {
        const { sut } = setup();
        const obj1 = new Person((void 0), (void 0), (void 0));
        const obj2 = new Person((void 0), (void 0), (void 0));
        sut
            .on(obj1)
            .ensure('name')
            .required()
...
describe('validation/validation.spec.ts/ValidationMessageProvider', function () {
    ...
    function setup(customMessages) {
        ...
        container.register(configuration, Registration.instance(ISink, eventLog));
        const originalMessages = customMessages === null || customMessages === void 0 ? void 0 : customMessages.map(({ rule }) => ({ rule, aliases: ValidationRuleAliasMessage.getDefaultMessages(rule) }));
        return {
    ...
    for (const property of specialPropertyNames) {
        it(`#parseMessage logs warning if the message contains contextual property expression w/o preceeding '$' - ${property}`, function () {
            ...
            const entry = log[0];
            assert.equal(entry.severity, 3 /* warn */);
            assert.equal(entry
                .toString()
    ...
    for (let i = 0, ii = rules.length; i < ii; i++) {
        ...
        it(`rule.message returns the registered message for a rule instance - ${title}`, function () {
            ...
            const actual = sut.getMessage($rule).evaluate(0 /* none */, scope, container, null);
    ...
    it('default messages can be overwritten by registering custom messages', function () {
        ...
        for (const { getRule } of rules) {
            ...
            const template = aliases.length === 1 ? aliases[0].defaultMessage : (_a = aliases.find(({ name }) => name === $rule.messageKey)) === null || _a === void 0 ? void 0 : _a.defaultMessage;
            const expected = sut.parseMessage(template).evaluate(0 /* none */, scope, null, null);
    ...
    it('appending new custom key and messages is also possible', function () {
        ...
        const actual1 = sut.getMessage($rule1).evaluate(0 /* none */, scope1, container, null);
        const actual2 = sut.getMessage($rule2).evaluate(0 /* none */, scope2, container, null);
    ...
    for (const { arg1, arg2, expected } of displayNames) {
        it(`#getDisplayName computes display name - (${arg1}, ${(_a = arg2 === null || arg2 === void 0 ? void 0 : arg2.toString()) !== null && _a !== void 0 ? _a : Object.prototype.toString.call(arg2)}) => ${expected}`, function () {
            const { sut } = setup();
...
describe('validation/validation.spec.ts/parsePropertyName', function () {
    ...
    const positiveDataRows = [
        ...
        { property: 'obj.prop["a"]', expected: 'obj.prop["a"]' },
        { property: 'obj.prop["a"].prop2', expected: 'obj.prop["a"].prop2' },
        { property: (o) => o.prop, expected: 'prop' },
        { property: (o) => o.obj.prop, expected: 'obj.prop' },
        { property: (o) => o.obj.prop1.prop2, expected: 'obj.prop1.prop2' },
        { property: (o) => o.prop[0], expected: 'prop[0]' },
        { property: (o) => o.prop[0].prop2, expected: 'prop[0].prop2' },
        { property: (o) => o.obj.prop[0], expected: 'obj.prop[0]' },
        { property: (o) => o.obj.prop[0].prop2, expected: 'obj.prop[0].prop2' },
        { property: (o) => o.prop[a], expected: 'prop[a]' },
        { property: (o) => o.prop[a].prop2, expected: 'prop[a].prop2' },
        { property: (o) => o.obj.prop[a], expected: 'obj.prop[a]' },
        { property: (o) => o.obj.prop[a].prop2, expected: 'obj.prop[a].prop2' },
        { property: (o) => o.prop['a'], expected: 'prop[\'a\']' },
        { property: (o) => o.prop['a'].prop2, expected: 'prop[\'a\'].prop2' },
        { property: (o) => o.obj.prop['a'], expected: 'obj.prop[\'a\']' },
        { property: (o) => o.obj.prop['a'].prop2, expected: 'obj.prop[\'a\'].prop2' },
        ...
        { property: (o) => o.obj.prop["a"], expected: 'obj.prop["a"]' },
        { property: (o) => o.obj.prop["a"].prop2, expected: 'obj.prop["a"].prop2' },
        { property: function (o) { return o.prop; }, expected: 'prop' },
        { property: function (o) { return o.obj.prop; }, expected: 'obj.prop' },
        { property: function (o) { return o.obj.prop1.prop2; }, expected: 'obj.prop1.prop2' },
        { property: function (o) { return o.prop[0]; }, expected: 'prop[0]' },
        { property: function (o) { return o.prop[0].prop2; }, expected: 'prop[0].prop2' },
        { property: function (o) { return o.obj.prop[0]; }, expected: 'obj.prop[0]' },
        { property: function (o) { return o.obj.prop[0].prop2; }, expected: 'obj.prop[0].prop2' },
        { property: function (o) { return o.prop[a]; }, expected: 'prop[a]' },
        { property: function (o) { return o.prop[a].prop2; }, expected: 'prop[a].prop2' },
        { property: function (o) { return o.obj.prop[a]; }, expected: 'obj.prop[a]' },
        { property: function (o) { return o.obj.prop[a].prop2; }, expected: 'obj.prop[a].prop2' },
        { property: function (o) { return o.prop['a']; }, expected: 'prop[\'a\']' },
        { property: function (o) { return o.prop['a'].prop2; }, expected: 'prop[\'a\'].prop2' },
        { property: function (o) { return o.obj.prop['a']; }, expected: 'obj.prop[\'a\']' },
        { property: function (o) { return o.obj.prop['a'].prop2; }, expected: 'obj.prop[\'a\'].prop2' },
        ...
        { property: function (o) {
                'use strict';
                return o.obj.prop1.prop2;
            }, expected: 'obj.prop1.prop2' },
        { property: function (o) {
                'use strict';
                return o.prop[0];
            }, expected: 'prop[0]' },
        { property: function (o) {
                'use strict';
                return o.prop[0].prop2;
            }, expected: 'prop[0].prop2' },
        { property: function (o) {
                'use strict';
                return o.obj.prop[0];
            }, expected: 'obj.prop[0]' },
        { property: function (o) {
                'use strict';
                return o.obj.prop[0].prop2;
            }, expected: 'obj.prop[0].prop2' },
        { property: function (o) {
                'use strict';
                return o.prop[a];
            }, expected: 'prop[a]' },
        { property: function (o) {
                'use strict';
                return o.prop[a].prop2;
            }, expected: 'prop[a].prop2' },
        { property: function (o) {
                'use strict';
                return o.obj.prop[a];
            }, expected: 'obj.prop[a]' },
        { property: function (o) {
                'use strict';
                return o.obj.prop[a].prop2;
            }, expected: 'obj.prop[a].prop2' },
        { property: function (o) {
                'use strict';
                return o.prop['a'];
            }, expected: 'prop[\'a\']' },
        ...
        { property: function (o) { cov_1wjh4ld5ut.s[50]++; return o.prop; }, expected: 'prop' },
        { property: function (o) { cov_1wjh4ld5ut.f[9]++; cov_1wjh4ld5ut.s[50]++; return o.prop; }, expected: 'prop' },
        { property: function (o) {
                "use strict";
                cov_1wjh4ld5ut.s[50]++;
                return o.prop;
        ...
        { property: function (o) { /* istanbul ignore next */ cov_1wjh4ld5ut.s[50]++; return o.prop; }, expected: 'prop' },
        { property: function (o) { /* istanbul ignore next */ cov_1wjh4ld5ut.f[9]++; cov_1wjh4ld5ut.s[50]++; return o.prop; }, expected: 'prop' },
        { property: function (o) {
    ...
    for (const { property, expected } of positiveDataRows) {
        it(`parses ${property.toString()} to ${expected}`, function () {
            const { parser } = setup();
            assert.deepStrictEqual(parsePropertyName(property, parser), [expected, parser.parse(`${rootObjectSymbol}.${expected}`, 0 /* None */)]);
        });
    }
    ...
    for (const { property } of negativeDataRows) {
        it(`throws error when parsing ${property.toString()}`, function () {
            const { parser } = setup();
            assert.throws(() => {
                parsePropertyName(property, parser);
...
describe('validation/validation.spec.ts/PropertyRule', function () {
    ...
    it('can validate async rules', async function () {
        ...
        const rules = validationRules
            .on(obj1)
            .ensure('name')
            .satisfies(async (value) => new Promise((resolve) => { setTimeout(() => { resolve(value === 'foo'); }, 300); }))
            .rules;
    ...
    it('respects rule chaining', async function () {
        const { validationRules } = setup();
        const obj = new Person('test', (void 0), (void 0));
        const rule = validationRules
            .on(obj)
            .ensure('name')
            .minLength(42)
