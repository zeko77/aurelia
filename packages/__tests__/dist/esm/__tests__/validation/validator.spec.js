...
describe('validation/validator.spec.ts/StandardValidator', function () {
    ...
    function assertValidationResult(result, isValid, propertyName, obj, rule, message) {
    ...
    for (const defineRuleOnClass of [true, false]) {
        const properties1 = [
            { title: 'string property', getProperty: () => 'name' },
            { title: 'lambda property', getProperty: () => ((o) => o.name) },
        ];
        for (const { title, getProperty } of properties1) {
            ...
            it(`if given, validates only the specific rules for an object property - ${title}`, async function () {
                ...
                const rules = validationRules
                    ...
                    .withMessage(message2)
                    .rules[0];
                const rule = new PropertyRule(container, rules['validationRules'], rules['messageProvider'], rules.property, [[rules.$rules[0][0]]]);
        ...
        const properties2 = [
            {
                ...
                getProperty1: () => 'name',
                getProperty2: () => 'age',
                getProperty3: () => 'address.line1'
            },
            {
                title: 'lambda property',
                getProperty1: () => ((o) => o.name),
                getProperty2: () => ((o) => o.age),
                getProperty3: () => ((o) => o.address.line1),
            },
        ];
        for (const { title, getProperty1, getProperty2, getProperty3 } of properties2) {
            it(`validates all rules by default for an object - ${title}`, async function () {
                const { sut, validationRules } = setup();
                const message1 = 'message1', message2 = 'message2';
                const obj = new Person((void 0), (void 0), { line1: 'invalid' });
                validationRules
                    .on(defineRuleOnClass ? Person : obj)
                    .ensure(getProperty1())
                    .required()
        ...
        const properties3 = [
            {
                title: 'string property',
                getProperty1: () => 'employees',
            },
            {
                title: 'lambda property',
                getProperty1: () => ((o) => o.employees),
            },
        ];
        for (const { title, getProperty1 } of properties3) {
            it(`can validate collection - ${title}`, async function () {
                ...
                const obj = new Organization([], (void 0));
                validationRules
        ...
        it(`respects registered custom message key`, async function () {
            ...
            const person = new Person((void 0), (void 0), { line1: (void 0), city: (void 0), pin: (void 0) });
            rules
    ...
    const properties4 = [
        {
            title: 'string property',
            getProperty1: () => 'coll[0].a',
            getProperty2: () => 'coll[1].a',
        },
        {
            title: 'lambda property',
            getProperty1: () => ((o) => o.coll[0].a),
            getProperty2: () => ((o) => o.coll[1].a),
        },
    ];
    ...
    const properties5 = [
        { title: 'string property', getProperty1: () => 'subprop[\'a\']' },
        { title: 'lambda property', getProperty1: () => ((o) => o.subprop['a']) },
    ];
    ...
    it(`can be used to validate an object with custom validation rule`, async function () {
        const { sut, validationRules: rules } = setup();
        const people = [new Person((void 0), (void 0), (void 0)), new Person((void 0), (void 0), (void 0))];
        const obj = { a: 1, b: 1 };
        ...
        rules
            .on(people)
            .ensureObject()
            .satisfies((o) => o[0].name === 'foo' && o[1].name === 'bar')
            .withMessage(msg1)
            .on(obj)
            .ensure('b')
            .equals(42)
