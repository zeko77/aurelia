  ...
  const recognizeSpecs: RecognizeSpec[] = [
    ...
    // d/d + s/d:b* + s/s
    {
      ...
      tests: [
        ...
        ['a/a',      'a/a',   null],
        ['aa/a',     'aa/:b*',     { b: 'a'                   }],
        ['aaa/a',    ':a(.)*/:b*', { a: 'aaa/a',    b: void 0 }],
        ['a/aa',     'a/:b*',      { b: 'aa'                  }],
        ['aa/aa',    'aa/:b*',     { b: 'aa'                  }],
        ['aaa/aa',   ':a(.)*/:b*', { a: 'aaa/aa',   b: void 0 }],
        ['a/a/a',    'a/:b*',      { b: 'a/a'                 }],
        ['a/aa/a',   'a/:b*',      { b: 'aa/a'                }],
        ['aa/a/a',   'aa/:b*',     { b: 'a/a'                 }],
        ['aaa/a/a',  ':a(.)*/:b*', { a: 'aaa/a/a',  b: void 0 }],
        ['a/a/aa',   'a/:b*',      { b: 'a/aa'                }],
        ['a/aa/aa',  'a/:b*',      { b: 'aa/aa'               }],
        ['aa/a/aa',  'aa/:b*',     { b: 'a/aa'                }],
        ['aaa/a/aa', ':a(.)*/:b*', { a: 'aaa/a/aa', b: void 0 }],
      ],
    },
    // d/d + s/d + s/s:b*
    {
    ...
    // d/d + d/s + s/d + s/s
    {
      ...
      tests: [
        ...
        ['aa/a/aa',  ':a(.)*/:b*', { a: 'aa/a/aa',  b: void 0 }],
        ['a/aa/aa',  'a/:b*',      { b: 'aa/aa'               }],
        ['aa/aa/aa', ':a(.)*/:b*', { a: 'aa/aa/aa', b: void 0 }],
      ],
    },
    // d/d + d/s:b* + s/d + s/s
    {
      ...
      tests: [
        ...
        ['aa/aa/aaa', ':a(.)*/:b*', { a: 'aa/aa/aaa', b: void 0 }],
      ],
    },
    // d/d + d/s + s/d:b* + s/s
    {
      ...
      tests: [
        ...
        ['aaa/aa/aa', ':a(.)*/:b*', { a: 'aaa/aa/aa', b: void 0 }],
      ],
    },
    // d/d + d/s:b* + s/d:b* + s/s
    {
      ...
      tests: [
        ...
        ['aa/aa',      'aa/:b*',     { b: 'aa'                    }],
        ['aaa/aa',     ':a(.)*/aa',  { a: 'aaa'                   }],
        ['aaa/aaa',    ':a(.)*/:b*', { a: 'aaa/aaa',    b: void 0 }],
        ['a/a/a',      'a/:b*',      { b: 'a/a'                   }],
        ['aa/a/a',     'aa/:b*',     { b: 'a/a'                   }],
        ['aaa/a/a',    ':a(.)*/a',   { a: 'aaa/a'                 }],
        ['a/aa/a',     'a/:b*',      { b: 'aa/a'                  }],
        ...
        ['aaa/a/aaa',  ':a(.)*/:b*', { a: 'aaa/a/aaa',  b: void 0 }],
        ['aa/aa/aa',   'aa/:b*',     { b: 'aa/aa'                 }],
        ['aaa/aa/aa',  ':a(.)*/aa',  { a: 'aaa/aa'                }],
        ['aaa/aa/aaa', ':a(.)*/:b*', { a: 'aaa/aa/aaa', b: void 0 }],
      ],
    },
    // #endregion
