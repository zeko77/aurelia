...
import { URLPatternInit, URLPatternInput, URLPatternResult } from '@aurelia/route-recognizer';

export class URLPatternTestData {
  public constructor(
...
export function* getData(): Generator<URLPatternTestData> {
