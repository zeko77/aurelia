...
class Endpoint$1 {
    ...
    getNavigationContent(t) {
        ...
        if (t instanceof Navigation) return null !== (i = this.contents.find((i => i.navigation === t))) && void 0 !== i ? i : null;
        return null;
    }
    get activeContent() {
        var t;
...
class RouterOptions {
    ...
    static for(t) {
        ...
        if (t instanceof Router) t = t.configuration; else t = t.get(b);
        return t.options;
    }
    apply(t) {
...
class InstructionComponent {
    ...
    static getName(t) {
        if (InstructionComponent.isName(t)) return t; else if (InstructionComponent.isType(t)) return i.CustomElement.getDefinition(t).name; else return InstructionComponent.getName(t.constructor);
    }
    static getType(t) {
    ...
    toType(t, n) {
        ...
        if (null !== this.name && "string" === typeof this.name) {
            ...
            if (t.has(i.CustomElement.keyFrom(this.name), true)) {
                const n = t.getResolver(i.CustomElement.keyFrom(this.name));
                if (null !== n && void 0 !== n.getFactory) {
                    const i = n.getFactory(t);
                    if (i) return i.Type;
                }
            }
        }
...
class Route {
    ...
    static isConfigured(t) {
        return n.Metadata.hasOwn(Route.resourceKey, t) || "parameters" in t || "title" in t;
    }
    static configure(t, i) {
        const s = Route.create(t, i);
        n.Metadata.define(Route.resourceKey, s, i);
        return i;
    }
    static getConfiguration(t) {
        var i;
        const s = null !== (i = n.Metadata.getOwn(Route.resourceKey, t)) && void 0 !== i ? i : {};
    ...
    static create(t, n = null) {
        var s, e, o, r, l, u, h, a, c;
        if (null !== n) t = Route.transferTypeToComponent(t, n);
        if (i.CustomElement.isType(t)) t = Route.getConfiguration(t); else if (null === n) t = {
            ...t
        };
        ...
        return new Route(null !== (s = f.path) && void 0 !== s ? s : "", null !== (o = null !== (e = f.id) && void 0 !== e ? e : d) && void 0 !== o ? o : null, null !== (r = f.redirectTo) && void 0 !== r ? r : null, null !== (l = f.instructions) && void 0 !== l ? l : null, null !== (u = f.caseSensitive) && void 0 !== u ? u : false, null !== (h = f.title) && void 0 !== h ? h : null, null !== (a = f.reloadBehavior) && void 0 !== a ? a : null, null !== (c = f.data) && void 0 !== c ? c : null);
    }
    static transferTypeToComponent(t, n) {
        var s;
        if (i.CustomElement.isType(t)) throw new Error(`Invalid route configuration: A component ` + `can't be specified in a component route configuration.`);
        const e = null !== (s = {
            ...t
        }) && void 0 !== s ? s : {};
        if ("component" in e || "instructions" in e) throw new Error(`Invalid route configuration: The 'component' and 'instructions' properties ` + `can't be specified in a component route configuration.`);
        if (!("redirectTo" in e)) e.component = n;
        if (!("path" in e) && !("redirectTo" in e)) e.path = i.CustomElement.getDefinition(n).name;
        return e;
    }
...
Route.resourceKey = t.Protocol.resource.keyFor("route");

const a = {
    name: t.Protocol.resource.keyFor("routes"),
    isConfigured(t) {
        return n.Metadata.hasOwn(a.name, t) || "routes" in t;
    },
    configure(t, i) {
        const s = t.map((t => Route.create(t)));
        n.Metadata.define(a.name, s, i);
        return i;
    },
    getConfiguration(t) {
        const i = t;
        const s = [];
        const e = n.Metadata.getOwn(a.name, t);
...
class ViewportScope extends Endpoint$1 {
    ...
    unbinding() {
        if (null !== this.sourceItem && null !== this.source) u(this.source, (t => t === this.sourceItem));
        this.sourceItem = null;
    }
    ...
    getRoutes() {
        ...
        if (null !== this.rootComponentType) {
            const n = this.rootComponentType.constructor === this.rootComponentType.constructor.constructor ? this.rootComponentType : this.rootComponentType.constructor;
            i.push(...null !== (t = a.getConfiguration(n)) && void 0 !== t ? t : []);
        }
        return i;
    }
}
...
class ViewportContent extends EndpointContent {
    ...
    canLoad() {
        ...
        if ("boolean" === typeof u || "string" === typeof u) return u;
        return u;
    }
    canUnload(t) {
...
class Viewport extends Endpoint$1 {
            ...
            if (this.isActiveNavigation(t)) {
                ...
                if ("boolean" === typeof s) {
                    ...
                    if ("string" === typeof s) {
                        ...
                        const o = null === (n = t.parent) || void 0 === n ? void 0 : n.findInstructions(e, i.useDirectRouting, i.useConfiguredRoutes);
                        if ((null === o || void 0 === o ? void 0 : o.foundConfiguration) || (null === o || void 0 === o ? void 0 : o.foundInstructions)) e = o.instructions;
                        for (const i of e) {
                            i.endpoint.set(this);
    ...
    unload(t, i) {
        return Runner.run(i, (i => this.getContent().connectedScope.unload(t, i)), (() => {
            var i;
            return null != this.getContent().componentInstance ? this.getContent().unload(null !== (i = t.navigation) && void 0 !== i ? i : null) : void 0;
        }));
    }
    dispose() {
        var t;
    ...
    finalizeContentChange(t, i) {
        ...
        let h = this.contents[l];
        const a = this.contents[l - 1];
        if (this.clear) {
            const t = new ViewportContent(this.router, this, this.owningScope, this.scope.hasScope, void 0, h.navigation);
        ...
        h.completed = true;
        this.transitionAction = "";
        h.contentStates.delete("checkedUnload");
        h.contentStates.delete("checkedLoad");
        this.previousViewportState = null;
        const c = this.router.configuration.options.indicators.viewportNavigating;
        null === (s = null === (n = this.connectedCE) || void 0 === n ? void 0 : n.setActivity) || void 0 === s ? void 0 : s.call(n, c, false);
        ...
        this.contents.splice(0, f);
        u(this.coordinators, (i => i === t));
    }
    cancelContentChange(t, i = null) {
        var n, s;
        [ ...new Set(this.scope.children.map((t => t.endpoint))) ].forEach((n => n.cancelContentChange(t, i)));
        ...
        if (e < 0) return;
        const o = null !== (s = null === (n = t.getEndpointStep(this)) || void 0 === n ? void 0 : n.current) && void 0 !== s ? s : null;
        const r = this.contents[e];
        const l = this.contents[e - 1];
        r.instruction.cancelled = true;
        return Runner.run(o, (t => r.freeContent(t, this.connectedCE, r.navigation, this.historyCache, this.router.statefulHistory || this.options.stateful)), (() => {
            var i, n, s, e;
            if (this.previousViewportState) Object.assign(this, this.previousViewportState);
            null === r || void 0 === r ? void 0 : r.delete();
            if (null !== r) this.contents.splice(this.contents.indexOf(r), 1);
            this.transitionAction = "";
            null === l || void 0 === l ? void 0 : l.contentStates.delete("checkedUnload");
            null === l || void 0 === l ? void 0 : l.contentStates.delete("checkedLoad");
            const o = this.router.configuration.options.indicators.viewportNavigating;
            null === (n = null === (i = this.connectedCE) || void 0 === i ? void 0 : i.setActivity) || void 0 === n ? void 0 : n.call(i, o, false);
            null === (e = null === (s = this.connectedCE) || void 0 === s ? void 0 : s.setActivity) || void 0 === e ? void 0 : e.call(s, t.navigation.navigation, false);
            ...
            if (o !== i) return null === o || void 0 === o ? void 0 : o.exit();
        }));
    }
    wantComponent(t) {
    ...
    freeContent(t, i) {
        ...
        if (void 0 !== n) return Runner.run(t, (t => {
            ...
            this.forceRemove = false;
            u(this.historyCache, (t => t === n));
        }));
    }
    getRoutes() {
        var t;
        const i = [];
        let n = this.getComponentType();
        if (null != n) {
            n = n.constructor === n.constructor.constructor ? n : n.constructor;
            i.push(...null !== (t = a.getConfiguration(n)) && void 0 !== t ? t : []);
        }
        return i;
    }
    ...
    getComponentType() {
        var t;
        let n = null !== (t = this.getContentInstruction().component.type) && void 0 !== t ? t : null;
        if (null === n) {
            const t = i.CustomElement.for(this.connectedCE.element);
            n = t.container.componentType;
        }
...
class RoutingInstruction {
    ...
    static from(t, n) {
        ...
        const s = [];
        for (const e of n) if ("string" === typeof e) s.push(...RoutingInstruction.parse(t, e)); else if (e instanceof RoutingInstruction) s.push(e); else if (e instanceof Promise) s.push(RoutingInstruction.create(e)); else if (InstructionComponent.isAppelation(e)) s.push(RoutingInstruction.create(e)); else if (InstructionComponent.isDefinition(e)) s.push(RoutingInstruction.create(e.Type)); else if ("component" in e) {
            const i = e;
            const n = RoutingInstruction.create(i.component, i.viewport, i.parameters);
            if (void 0 !== i.children && null !== i.children) n.nextScopeInstructions = RoutingInstruction.from(t, i.children);
            s.push(n);
        } else if ("object" === typeof e && null !== e) {
            const t = i.CustomElement.define(e);
            s.push(RoutingInstruction.create(t));
        } else s.push(RoutingInstruction.create(e));
        return s;
    }
    static clear(t) {
...
exports.Navigator = o([ r(0, t.IEventAggregator), r(1, t.IContainer) ], exports.Navigator);

const f = s.RouteRecognizer;

const d = s.ConfigurableRoute;

const v = s.RecognizedRoute;
...
class EndpointMatcher {
    static matchEndpoints(t, i, n, s = false) {
        ...
        const l = r.filter((t => null !== t && !n.some((i => t === i.endpoint.instance && !i.cancelled))));
...
class RoutingScope {
    ...
    static for(t) {
        ...
        if ("res" in t) s = t; else if ("container" in t) s = t.container; else if ("$controller" in t) s = t.$controller.container; else {
            const n = i.CustomElement.for(t, {
                searchParents: true
            });
            s = null === n || void 0 === n ? void 0 : n.container;
        }
        if (null == s) return null;
        const e = s.has(Router.closestEndpointKey, true) ? s.get(Router.closestEndpointKey) : null;
        return null !== (n = null === e || void 0 === e ? void 0 : e.scope) && void 0 !== n ? n : null;
    }
    get scope() {
    ...
    async processInstructions(t, i, n, s, e = "") {
        var o, r, l, h;
        const a = this.router;
        const c = a.configuration.options;
        const f = t.filter((t => !(t.route instanceof Route)));
        if (f.length > 0) {
            const i = this.findInstructions(f, c.useDirectRouting, c.useConfiguredRoutes);
            if (f.some((t => !t.component.none || null != t.route)) && !i.foundConfiguration && !i.foundInstructions) this.unknownRoute(f);
        ...
        for (const i of t.filter((t => t.isAddAll(a)))) {
            i.endpoint.set(i.scope.endpoint.name);
            i.scope = i.scope.owningScope;
        }
        let p = [];
        let {matchedInstructions: g, remainingInstructions: w} = this.matchEndpoints(t, i);
        let m = 100;
        do {
            if (!m--) a.unresolvedInstructionsError(n, w);
            const c = [];
            const f = g.map((t => t.endpoint.instance));
            g.push(...v.filter((t => !f.includes(t))).map((t => RoutingInstruction.createClear(a, t))));
            const d = await RoutingHook.invokeBeforeNavigation(g, n);
            if (false === d) {
                a.cancelNavigation(n, s);
                return [];
            } else if (true !== d && d !== g) {
                const t = RoutingInstruction.flat(g);
                w = w.filter((i => !t.includes(i)));
                g = d;
            }
            for (const t of g) {
                const l = t.endpoint.instance;
                if (null !== l) {
                    const h = l.setNextContent(t, n);
                    if ("skip" !== h) {
                        c.push(l);
                        s.addEndpoint(l);
                    }
                    const f = [ l ];
                    if ("swap" === h) f.push(...l.getContent().connectedScope.allScopes(true).map((t => t.endpoint)));
                    u(v, (t => f.includes(t)));
                    u(g, (i => i !== t && i.isClear(a) && f.includes(i.endpoint.instance)));
                    if (!t.isClear(a) && (null === (r = null === (o = t.scope) || void 0 === o ? void 0 : o.parent) || void 0 === r ? void 0 : r.isViewportScope)) {
                        u(v, (i => i === t.scope.parent.endpoint));
                        u(g, (i => i !== t && i.isClear(a) && i.endpoint.instance === t.scope.parent.endpoint));
                    }
                    if ("skip" !== h && t.hasNextScopeInstructions) for (const i of t.nextScopeInstructions) {
                        i.scope = l.scope;
                        i.endpoint.instance = null;
                    }
                    if ("skip" === h && !t.hasNextScopeInstructions) p.push(...await l.scope.processInstructions([], i, n, s, e));
                }
            }
            const R = g.filter((t => {
                var i;
            ...
            const I = R.filter((t => t.hasNextScopeInstructions));
            if (0 === R.length || 0 === I.length) {
                if (!a.isRestrictedNavigation) s.finalEndpoint();
                s.run();
            ...
            for (const t of c) if (p.every((i => i !== t))) p.push(t);
            i.push(...g.splice(0));
            if (w.length > 0) ({matchedInstructions: g, remainingInstructions: w} = this.matchEndpoints(w, i));
            if (!a.isRestrictedNavigation && (g.length > 0 || w.length > 0) && s.running) {
            ...
            if (0 === g.length && 0 === w.length) {
                ...
                for (const r of t) {
                    ...
                    const t = null !== (h = null === (l = r.endpoint.instance) || void 0 === l ? void 0 : l.scope) && void 0 !== h ? h : r.endpoint.scope;
                    o.push(t.processInstructions(r.nextScopeInstructions, i, n, s, e));
                }
                p.push(...(await Promise.all(o)).flat());
            }
            ...
            i.filter((t => t.cancelled)).forEach((t => {
                ...
                const s = i[n];
                if (s.cancelled) p = p.filter((t => t !== s.endpoint.instance));
            }));
    ...
    findInstructions(t, i, n) {
        var s, e, o;
        const r = this.router;
        let l = new FoundRoute;
        if (n && !RoutingInstruction.containsSiblings(r, t)) {
            let n = t.filter((t => t.isClear(r) || t.isClearAll(r)));
            const u = t.filter((t => !t.isClear(r) && !t.isClearAll(r)));
            if (u.length > 0) for (const h of u) {
                const a = this.findMatchingRoute(null !== (s = h.unparsed) && void 0 !== s ? s : RoutingInstruction.stringify(r, u));
                if (null !== (e = null === a || void 0 === a ? void 0 : a.foundConfiguration) && void 0 !== e ? e : false) {
                    l = a;
                    l.instructions = [ ...n, ...l.instructions ];
                    n = [];
                } else if (i) {
                    l.instructions = [ ...n, ...l.instructions, h ];
                    n = [];
                    l.remaining = RoutingInstruction.stringify(r, null !== (o = h.nextScopeInstructions) && void 0 !== o ? o : []);
                } else throw new Error(`No route found for: ${RoutingInstruction.stringify(r, t)}!`);
            } else l.instructions = [ ...n ];
        } else if (i) l.instructions.push(...t); else throw new Error(`No way to process sibling viewport routes with direct routing disabled: ${RoutingInstruction.stringify(r, t)}!`);
        l.instructions = l.instructions.filter((t => "" !== t.component.name));
        for (const t of l.instructions) if (null === t.scope) t.scope = this;
        return l;
    }
    ...
    getRoutingInstructions(t) {
        var i;
        const n = h(this.getOwnedRoutingScopes(t).map((t => t.endpoint))).map((i => i.getTimeContent(t))).filter((t => null !== t));
        const s = [];
        for (const e of n) {
    ...
    findMatchingRoute(t) {
        let i = null;
        if (this.isViewportScope && !this.passThroughScope) i = this.findMatchingRouteInRoutes(t, this.endpoint.getRoutes()); else if (this.isViewport) i = this.findMatchingRouteInRoutes(t, this.endpoint.getRoutes()); else for (const n of this.enabledChildren) {
            i = n.findMatchingRoute(t);
            if (null === i || void 0 === i ? void 0 : i.foundConfiguration) break;
        }
        if (null === i || void 0 === i ? void 0 : i.foundConfiguration) return i;
        if (null != this.parent) return this.parent.findMatchingRoute(t);
        return i;
    }
...
let g = class BrowserViewerStore {
...
g = o([ r(0, i.IPlatform), r(1, i.IWindow), r(2, i.IHistory), r(3, i.ILocation), r(4, t.IEventAggregator) ], g);
...
class NavigationCoordinator {
    ...
    removeEndpoint(t) {
        ...
        if (void 0 !== i) u(this.entities, (t => t === i));
    }
    setEndpointStep(t, i) {
    ...
    getEndpointStep(t) {
        var i;
        const n = this.entities.find((i => i.endpoint === t));
        return null !== (i = null === n || void 0 === n ? void 0 : n.step) && void 0 !== i ? i : null;
    }
    ...
    dequeueAppendedInstructions(t, i, n) {
        ...
        while (s.length > 0) {
            const e = s.shift();
            u(this.appendedInstructions, (t => t === e));
            const o = i.some((t => !t.cancelled && t.sameEndpoint(e, true)));
            ...
            if (void 0 !== r) u(t, (t => t === r));
            if (void 0 !== l) u(n, (t => t === l));
...
const w = t.DI.createInterface("IRouter", (t => t.singleton(Router)));
...
class Router {
    ...
    static get inject() {
        return [ t.IContainer, t.IEventAggregator, exports.Navigator, g, g, b ];
    }
    get isNavigating() {
    ...
    start() {
        ...
        if (null === n.basePath) {
            ...
            n.basePath = i.pathname;
        }
        if (n.basePath.endsWith("/")) n.basePath = n.basePath.slice(0, -1);
...
const R = t.DI.createInterface("ILinkHandler", (t => t.singleton(exports.LinkHandler)));
...
exports.LinkHandler = class LinkHandler {
    ...
    handleClick(t) {
        ...
        if (e.hasAttribute("external")) return;
        const o = null !== (n = e.getAttribute("target")) && void 0 !== n ? n : "";
        if (o.length > 0 && o !== this.window.name && "_self" !== o) return;
        const r = i.CustomAttribute.for(e, "load");
        const l = void 0 !== r ? r.viewModel.value : null;
        const u = this.router.configuration.options.useHref && e.hasAttribute("href") ? e.getAttribute("href") : null;
        if ((null === l || 0 === l.length) && (null === u || 0 === u.length)) return;
        t.preventDefault();
        let h = null !== (s = null !== l && void 0 !== l ? l : u) && void 0 !== s ? s : "";
        if ("string" === typeof h && h.startsWith("#")) {
            h = h.slice(1);
            if (!h.startsWith("/")) h = `/${h}`;
        }
        this.router.load(h, {
...
exports.LinkHandler = o([ r(0, i.IWindow), r(1, w) ], exports.LinkHandler);
...
function y(t, n, s, e) {
    var o, r;
    let l = null === (r = null === (o = i.CustomAttribute.for(s, "considered-active")) || void 0 === o ? void 0 : o.viewModel) || void 0 === r ? void 0 : r.value;
    if (void 0 === l) l = e;
    const u = t.applyLoadOptions(l, {
        context: n
    });
    const h = RoutingInstruction.from(t, u.instructions);
    for (const t of h) if (null === t.scope) t.scope = u.scope;
    return h;
}
...
const x = i.CustomElement.createInjectable();
...
exports.ViewportCustomElement = class ViewportCustomElement {
    ...
    hydrated(t) {
        ...
        return Runner.run(null, (() => C(this.router, this.ea)), (() => {
    ...
    connect() {
        ...
        const n = E("name", this.name, t, i);
        const s = {};
        s.scope = !E("no-scope", this.noScope, false, i, true);
        ...
        s.stateful = E("stateful", this.stateful, t, i, true);
...
o([ i.bindable ], exports.ViewportCustomElement.prototype, "name", void 0);

o([ i.bindable ], exports.ViewportCustomElement.prototype, "usedBy", void 0);
...
o([ i.bindable ], exports.ViewportCustomElement.prototype, "noLink", void 0);

o([ i.bindable ], exports.ViewportCustomElement.prototype, "noTitle", void 0);

o([ i.bindable ], exports.ViewportCustomElement.prototype, "noHistory", void 0);

o([ i.bindable ], exports.ViewportCustomElement.prototype, "stateful", void 0);

exports.ViewportCustomElement = o([ i.customElement({
    name: "au-viewport",
    injectable: x
}), r(0, w), r(1, i.INode), r(2, t.IContainer), r(3, t.IEventAggregator), r(4, x), r(5, i.IInstruction) ], exports.ViewportCustomElement);

const N = i.CustomElement.createInjectable();
...
o([ i.bindable ], exports.ViewportScopeCustomElement.prototype, "name", void 0);

o([ i.bindable ], exports.ViewportScopeCustomElement.prototype, "catches", void 0);

o([ i.bindable ], exports.ViewportScopeCustomElement.prototype, "collection", void 0);

o([ i.bindable ], exports.ViewportScopeCustomElement.prototype, "source", void 0);

exports.ViewportScopeCustomElement = o([ i.customElement({
    name: "au-viewport-scope",
    template: "<template></template>",
    containerless: false,
    injectable: N
}), r(0, w), r(1, i.INode), r(2, t.IContainer), r(3, N), r(4, i.IController) ], exports.ViewportScopeCustomElement);
...
exports.LoadCustomAttribute = class LoadCustomAttribute {
    ...
    updateActive() {
        ...
        const n = y(this.router, t, this.element, this.value);
        const s = S(this.element);
...
exports.LoadCustomAttribute = o([ i.customAttribute("load"), r(0, i.INode), r(1, w), r(2, R), r(3, t.IEventAggregator) ], exports.LoadCustomAttribute);
...
exports.HrefCustomAttribute = class HrefCustomAttribute {
    ...
    hasLoad() {
        ...
        const n = i.children;
        return null !== (t = null === n || void 0 === n ? void 0 : n.some((t => 1 === t.vmKind && t.viewModel instanceof exports.LoadCustomAttribute))) && void 0 !== t ? t : false;
    }
};
...
exports.HrefCustomAttribute = o([ i.customAttribute({
    name: "href",
    noMultiBindings: true
}), r(0, i.INode), r(1, w), r(2, R), r(3, t.IEventAggregator) ], exports.HrefCustomAttribute);
...
exports.ConsideredActiveCustomAttribute = o([ i.customAttribute("considered-active") ], exports.ConsideredActiveCustomAttribute);

const b = t.DI.createInterface("IRouterConfiguration", (t => t.singleton(RouterConfiguration)));

const k = w;

const $ = [ k ];

const P = exports.ViewportCustomElement;

const T = exports.ViewportScopeCustomElement;

const V = exports.LoadCustomAttribute;

const A = exports.HrefCustomAttribute;

const O = [ exports.ViewportCustomElement, exports.ViewportScopeCustomElement, exports.LoadCustomAttribute, exports.HrefCustomAttribute, exports.ConsideredActiveCustomAttribute ];
...
exports.ConfigurableRoute = d;

exports.DefaultComponents = $;

exports.DefaultResources = O;
...
exports.HrefCustomAttributeRegistration = A;

exports.ILinkHandler = R;

exports.IRouter = w;

exports.IRouterConfiguration = b;

exports.InstructionParameters = InstructionParameters;

exports.LoadCustomAttributeRegistration = V;
...
exports.RecognizedRoute = v;

exports.RecognizerEndpoint = p;

exports.Route = Route;

exports.RouteRecognizer = f;
...
exports.ViewportCustomElementRegistration = P;
...
exports.ViewportScopeCustomElementRegistration = T;
