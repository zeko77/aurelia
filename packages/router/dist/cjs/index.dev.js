...
class ViewportContent extends EndpointContent {
    ...
    getLifecycleHooks(instance, name) {
        ...
        return hooks.map(hook => hook.instance[name]);
    }
}
...
exports.HrefCustomAttribute = class HrefCustomAttribute {
    ...
    hasLoad() {
        ...
        return (_a = siblings === null || siblings === void 0 ? void 0 : siblings.some(c => c.vmKind === 1 /* customAttribute */ && c.viewModel instanceof exports.LoadCustomAttribute)) !== null && _a !== void 0 ? _a : false;
    }
};
__decorate([
    runtimeHtml.bindable({ mode: runtimeHtml.BindingMode.toView })
