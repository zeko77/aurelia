...
import { astEvaluator as r, BindingMode as o, bindingBehavior as c, BindingInterceptor as a, attributePattern as u, bindingCommand as l, renderer as f, AttrSyntax as d, IAttrMapper as g, IPlatform as p, applyBindingBehavior as b, lifecycleHooks as S, CustomElement as m, CustomAttribute as v, ILifecycleHooks as B } from "../../../runtime-html/dist/native-modules/index.mjs";

import { Scope as y, connectable as w, IExpressionParser as I, IObserverLocator as P } from "../../../runtime/dist/native-modules/index.mjs";
...
class StateBinding {
    ...
    $bind(t, i) {
        ...
        this.updateTarget(this.v = this.ast.evaluate(this.$scope, this, this.mode > E ? this : null), 0);
    }
    $unbind() {
        if (!this.isBound) return;
        this.C();
...
let L = class StateBindingBehavior extends a {
    ...
    $bind(t, i) {
        ...
        const n = this.T ? i : j(this.A.getState(), i);
