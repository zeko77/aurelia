...
import { astEvaluator, BindingMode, bindingBehavior, BindingInterceptor, attributePattern, bindingCommand, renderer, AttrSyntax, IAttrMapper, IPlatform, applyBindingBehavior, lifecycleHooks, CustomElement, CustomAttribute, ILifecycleHooks } from '@aurelia/runtime-html';
